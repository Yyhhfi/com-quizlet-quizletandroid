...
public abstract class ClassUtil {
    ...
    private static Method[] _failGetClassMethods(Class<?> cls, Throwable th) throws IllegalArgumentException {
        ...
        StringBuilder sbH = AbstractC0147y.h("Failed on call to `getDeclaredMethods()` on class `", name, "`, problem: (", name2, ") ");
        sbH.append(message);
        throw new IllegalArgumentException(sbH.toString(), th);
    }
    ...
    public static void checkAndFixAccess(Member member, boolean z) throws SecurityException {
        ...
        try {
            ...
            StringBuilder sbH = AbstractC0147y.h("Failed to call `setAccess()` on ", simpleName, " '", name, "' (of class ");
            B.u(sbH, strNameOf, ") due to `", name2, "`, problem: ");
            sbH.append(message);
            throw new IllegalArgumentException(sbH.toString(), e2);
        }
    }
    ...
    public static <T> T createInstance(Class<T> cls, boolean z) throws NoSuchMethodException, SecurityException, IllegalArgumentException {
        ...
        if (constructorFindConstructor == null) {
            throw new IllegalArgumentException(a.i(cls, new StringBuilder("Class "), " has no default (no arg) constructor"));
        }
        try {
    ...
    public static Object defaultValue(Class<?> cls) {
        ...
        throw new IllegalArgumentException(a.i(cls, new StringBuilder("Class "), " is not a primitive type"));
    }
    ...
    public static void verifyMustOverride(Class<?> cls, Object obj, String str) {
        if (obj.getClass() != cls) {
            throw new IllegalStateException(android.support.v4.media.session.a.t(AbstractC0147y.h("Sub-class ", obj.getClass().getName(), " (of class ", cls.getName(), ") must override method '"), str, "'"));
        }
    }
    ...
    public static class EnumTypeLocator {
        ...
        private static Field locateField(Class<?> cls, String str, Class<?> cls2) throws Exception {
            ...
            throw new IllegalStateException(AbstractC0147y.e("No field named '", str, "' in class '", cls.getName(), "'"));
        }
