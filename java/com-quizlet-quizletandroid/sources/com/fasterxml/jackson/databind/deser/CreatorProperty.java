...
public class CreatorProperty extends SettableBeanProperty {
    ...
    private void _reportMissingSetter(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException {
        ...
        String strE = AbstractC0147y.e("No fallback setter/field defined for creator property ", ClassUtil.name(getName()), " (of ", annotatedParameter == null ? "UNKNOWN TYPE" : ClassUtil.getClassDescription(annotatedParameter.getOwner().getDeclaringClass()), ")");
        if (deserializationContext == null) {
            throw InvalidDefinitionException.from(jsonParser, strE, getType());
        }
        deserializationContext.reportBadDefinition(getType(), strE);
    }
