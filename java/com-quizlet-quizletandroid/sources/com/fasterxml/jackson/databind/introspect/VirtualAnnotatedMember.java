...
public class VirtualAnnotatedMember extends AnnotatedMember implements Serializable {
    ...
    public Object getValue(Object obj) throws IllegalArgumentException {
        throw new IllegalArgumentException(android.support.v4.media.session.a.t(new StringBuilder("Cannot get virtual property '"), this._name, "'"));
    }
    ...
    public void setValue(Object obj, Object obj2) throws IllegalArgumentException {
        throw new IllegalArgumentException(android.support.v4.media.session.a.t(new StringBuilder("Cannot set virtual property '"), this._name, "'"));
    }
