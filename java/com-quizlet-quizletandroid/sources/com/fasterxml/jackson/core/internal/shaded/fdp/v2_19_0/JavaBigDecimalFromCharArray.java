...
final class JavaBigDecimalFromCharArray extends AbstractBigDecimalParser {
    public BigDecimal parseBigDecimalString(char[] cArr, int i, int i2) {
        ...
        try {
            ...
            boolean z2 = cCharAt == '-';
            if ((z2 || cCharAt == '+') && (cCharAt = AbstractNumberParser.charAt(cArr, (i6 = i6 + 1), iCheckBounds)) == 0) {
            ...
            while (true) {
                ...
                if (c >= '\n') {
                    ...
                    z3 |= i7 >= 0;
                    int i9 = i8;
                    while (i9 < iCheckBounds - 4 && (iTryToParseFourDigits = FastDoubleSwar.tryToParseFourDigits(cArr, i9 + 1)) >= 0) {
            ...
            if ((cCharAt | ' ') == 101) {
                int i10 = i8 + 1;
                char cCharAt2 = AbstractNumberParser.charAt(cArr, i10, iCheckBounds);
                boolean z4 = cCharAt2 == '-' ? z : false;
                if (z4 || cCharAt2 == '+') {
                    i10 = i8 + 2;
                    cCharAt2 = AbstractNumberParser.charAt(cArr, i10, iCheckBounds);
                }
                ...
                while (true) {
                    ...
                    j2 = j4;
                    i10++;
                    char cCharAt3 = (char) (AbstractNumberParser.charAt(cArr, i10, iCheckBounds) - '0');
                    if (cCharAt3 >= '\n') {
                        break;
                    }
                    j4 = j2;
