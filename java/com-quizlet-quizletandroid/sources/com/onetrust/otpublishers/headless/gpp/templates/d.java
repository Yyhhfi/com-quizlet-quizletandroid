...
public final class d {
    ...
    public final void a() {
        ...
        try {
            if (new com.onetrust.otpublishers.headless.gpp.d(context).d("USNATIONAL")) {
                return;
            }
            String strB = b();
            OTLogger.c("OneTrust", 4, "Gpp - US NATIONAL String : " + strB);
            if (com.onetrust.otpublishers.headless.Internal.a.j(strB)) {
                return;
            }
            new com.onetrust.otpublishers.headless.Internal.Preferences.a(context).c(OTGppKeys.IAB_GPP_US_NAT_STRING, strB);
        } catch (Exception e) {
            OTLogger.c("OneTrust", 6, "computeUSNationalString failed:" + e);
        }
    }
