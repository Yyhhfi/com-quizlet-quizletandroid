...
public class OTThemeConstants {
    ...
    public static final String OT_SDK_UI_THEME = "OT_SDK_UI_THEME";
    public static final String OT_THEME_APP_COMPACT_LIGHT_NO_ACTION_BAR = "OT_THEME_APP_COMPACT_LIGHT_NO_ACTION_BAR";
    public static final String OT_THEME_APP_COMPACT_LIGHT_NO_ACTION_BAR_LANDSCAPE_FULL_SCREEN = "OT_THEME_APP_COMPACT_LIGHT_NO_ACTION_BAR_LANDSCAPE_FULL_SCREEN";
