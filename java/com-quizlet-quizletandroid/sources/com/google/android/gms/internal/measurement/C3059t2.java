...
public final class C3059t2 extends K1 implements RandomAccess {
    public static final Object[] d;
    public static final C3059t2 e;
    public Object[] b;
    public int c;
    ...
    static {
        ...
        d = objArr;
        e = new C3059t2(objArr, 0, false);
    }

    public C3059t2(Object[] objArr, int i, boolean z) {
        super(z);
        this.b = objArr;
        this.c = i;
    }
    ...
    public final /* bridge */ /* synthetic */ InterfaceC2975c2 f(int i) {
        if (i >= this.c) {
            return new C3059t2(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
