...
public final class C2827xc {
    public final InterfaceC2441oc a;
    public final Context b;
    public final BinderC1661Ac c;
    public final long d;

    public C2827xc(Context context, String str) {
        C1608n c1608n = C1614q.f.b;
        BinderC2739va binderC2739va = new BinderC2739va();
        c1608n.getClass();
        InterfaceC2441oc interfaceC2441oc = (InterfaceC2441oc) new C1584b(context, str, binderC2739va).d(context, false);
        this.d = System.currentTimeMillis();
        this.b = context.getApplicationContext();
        this.a = interfaceC2441oc;
    ...
    public static void a(Context context, String str, com.google.android.gms.ads.g gVar, C2578rl c2578rl) {
        ...
        if (((Boolean) U7.k.o()).booleanValue()) {
            if (((Boolean) com.google.android.gms.ads.internal.client.r.d.c.a(AbstractC2773w7.hb)).booleanValue()) {
                com.google.android.gms.ads.internal.util.client.a.b.execute(new RunnableC0069f(7, context, str, gVar, c2578rl, false));
                return;
            }
        }
        com.google.android.gms.ads.internal.util.client.i.d("Loading on UI thread");
        new C2827xc(context, str).b(gVar.zza(), c2578rl);
    }
    ...
    public final void b(com.google.android.gms.ads.internal.client.y0 y0Var, C2578rl c2578rl) {
        try {
            ...
            if (interfaceC2441oc != null) {
                y0Var.n = this.d;
                interfaceC2441oc.Z2(com.google.android.gms.ads.internal.client.R0.a(this.b, y0Var), new BinderC2870yc(c2578rl, this, 0));
            }
