...
public final class X1 extends K1 implements RandomAccess, InterfaceC2965a2, InterfaceC3049r2 {
    ...
    static {
        int[] iArr = new int[0];
        d = iArr;
        e = new X1(iArr, 0, false);
    }

    public X1(int[] iArr, int i, boolean z) {
        super(z);
        this.b = iArr;
        this.c = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(x1.b, 0, this.b, this.c, x1.c);
        this.c = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final X1 f(int i) {
        if (i >= this.c) {
            return new X1(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
