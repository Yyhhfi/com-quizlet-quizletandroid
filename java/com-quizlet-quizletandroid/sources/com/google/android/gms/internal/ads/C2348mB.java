...
public final class C2348mB extends AbstractC2690uA implements RandomAccess {
    public static final Object[] d;
    public static final C2348mB e;
    public Object[] b;
    public int c;
    ...
    static {
        ...
        d = objArr;
        e = new C2348mB(objArr, 0, false);
    }

    public C2348mB(Object[] objArr, int i, boolean z) {
        super(z);
        this.b = objArr;
        this.c = i;
    }
    ...
    public final /* bridge */ /* synthetic */ VA d(int i) {
        if (i >= this.c) {
            return new C2348mB(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
