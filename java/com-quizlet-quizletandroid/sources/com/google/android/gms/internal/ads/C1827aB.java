...
public final class C1827aB extends AbstractC2690uA implements RandomAccess, UA, InterfaceC2262kB {
    public static final long[] d;
    public static final C1827aB e;
    public long[] b;
    public int c;
    ...
    static {
        ...
        d = jArr;
        e = new C1827aB(jArr, 0, false);
    }

    public C1827aB(long[] jArr, int i, boolean z) {
        super(z);
        this.b = jArr;
        this.c = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        collection.getClass();
        if (!(collection instanceof C1827aB)) {
            return super.addAll(collection);
        }
        C1827aB c1827aB = (C1827aB) collection;
        int i = c1827aB.c;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(c1827aB.b, 0, this.b, this.c, c1827aB.c);
        this.c = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final C1827aB d(int i) {
        if (i >= this.c) {
            return new C1827aB(i == 0 ? d : Arrays.copyOf(this.b, i), this.c, true);
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof C1827aB)) {
            return super.equals(obj);
        }
        C1827aB c1827aB = (C1827aB) obj;
        if (this.c != c1827aB.c) {
            return false;
        }
        long[] jArr = c1827aB.b;
