...
public class TextInputEditText extends C0116w {
    public final Rect g;
    public boolean h;
    ...
    public TextInputEditText(Context context, AttributeSet attributeSet, int i) {
        super(com.google.android.material.theme.overlay.a.a(context, attributeSet, i, 0), attributeSet, i);
        this.g = new Rect();
        int[] iArr = com.google.android.material.a.R;
        com.google.android.material.internal.p.c(context, attributeSet, i, R.style.Widget_Design_TextInputEditText);
        com.google.android.material.internal.p.d(context, attributeSet, iArr, i, R.style.Widget_Design_TextInputEditText, new int[0]);
