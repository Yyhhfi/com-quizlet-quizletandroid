...
public final class i extends SQLiteOpenHelper {
    ...
    public static final List e = Arrays.asList(new h(0), new h(1), new h(2), new h(3), new h(4), new h(5), new h(6));
    public final int a;
    public boolean b;
    ...
    public static void a(SQLiteDatabase sQLiteDatabase, int i, int i2) throws SQLException {
        List list = e;
        if (i2 > list.size()) {
            StringBuilder sbW = android.support.v4.media.session.a.w("Migration from ", i, " to ", " was requested, but cannot be performed. Only ", i2);
