...
public final class SetPushNotificationSubscriptionStep extends BaseBrazeActionStep {
    ...
    public void run(@NotNull Context context, @NotNull StepData data) {
        ...
        if (notificationSubscriptionTypeFromValue == null) {
            BrazeLogger.brazelog$default(BrazeLogger.INSTANCE, (Object) this, (BrazeLogger.Priority) null, (Throwable) null, false, (Function0) new b(2, data), 7, (Object) null);
        } else {
            BaseBrazeActionStep.Companion.runOnUser$android_sdk_ui_release(Braze.Companion.getInstance(context), new f(notificationSubscriptionTypeFromValue, 3));
        }
    }
}
