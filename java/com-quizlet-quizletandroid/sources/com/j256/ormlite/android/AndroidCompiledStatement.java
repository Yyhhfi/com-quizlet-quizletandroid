...
public class AndroidCompiledStatement implements CompiledStatement {
    ...
    public static int execSql(SQLiteDatabase sQLiteDatabase, String str, String str2, Object[] objArr) throws SQLException, android.database.SQLException {
        ...
        try {
            ...
            throw new SQLException(a.m("Problems executing ", str, " Android statement: ", str2), e);
        }
    }
    ...
    public Cursor getCursor() throws SQLException {
        if (this.cursor == null) {
            ...
            try {
                ...
                throw new SQLException(AbstractC0147y.d("Problems executing Android query: ", str), e);
            }
        }
        return this.cursor;
    }
