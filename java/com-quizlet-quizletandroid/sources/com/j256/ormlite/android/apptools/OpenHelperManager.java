    ...
    private static OrmLiteSqliteOpenHelper constructHelper(Context context, Class<? extends OrmLiteSqliteOpenHelper> cls) {
        try {
            try {
                ...
                throw new IllegalStateException(B.d(cls, "Could not construct instance of helper class "), e);
            }
        } catch (Exception e2) {
            throw new IllegalStateException(B.d(cls, "Could not find public constructor that has a single (Context) argument for helper class "), e2);
        }
    }
    ...
    private static Class<? extends OrmLiteSqliteOpenHelper> lookupHelperClass(Context context, Class<?> cls) throws Resources.NotFoundException {
        ...
        if (identifier != 0) {
            ...
            try {
                ...
                throw new IllegalStateException(AbstractC0147y.d("Could not create helper instance for class ", string), e);
            }
        }
