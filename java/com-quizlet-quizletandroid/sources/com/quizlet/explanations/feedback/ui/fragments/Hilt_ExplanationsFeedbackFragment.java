...
public abstract class Hilt_ExplanationsFeedbackFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            ExplanationsFeedbackFragment explanationsFeedbackFragment = (ExplanationsFeedbackFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((d) d());
            explanationsFeedbackFragment.a = jVar.d.a();
            explanationsFeedbackFragment.b = jVar.b.S0();
        }
    }
