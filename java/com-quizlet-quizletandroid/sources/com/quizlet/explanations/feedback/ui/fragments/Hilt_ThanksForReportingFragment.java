...
public abstract class Hilt_ThanksForReportingFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            ThanksForReportingFragment thanksForReportingFragment = (ThanksForReportingFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((k) d());
            thanksForReportingFragment.a = jVar.d.a();
            thanksForReportingFragment.b = jVar.b.S0();
        }
    }
