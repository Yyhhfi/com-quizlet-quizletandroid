...
public abstract class Hilt_ReportThisContentFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            ReportThisContentFragment reportThisContentFragment = (ReportThisContentFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((i) d());
            reportThisContentFragment.a = jVar.d.a();
            reportThisContentFragment.b = jVar.b.S0();
        }
    }
