...
public abstract class Hilt_TableOfContentsFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            tableOfContentsFragment.a = jVar.d.a();
            u uVar = jVar.b;
            tableOfContentsFragment.b = uVar.S0();
            tableOfContentsFragment.j = new com.google.mlkit.common.sdkinternal.model.a(25);
            tableOfContentsFragment.k = (com.quizlet.qutils.image.loading.a) uVar.s.get();
        }
    }
