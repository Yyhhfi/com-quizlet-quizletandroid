...
public final class c extends d {
    ...
    public c(String name, String subHeaderChapterTitle, String str, String str2, String str3, boolean z, boolean z2, X x, boolean z3) {
    ...
    public final boolean equals(Object obj) {
        ...
        c cVar = (c) obj;
        return Intrinsics.b(this.d, cVar.d) && Intrinsics.b(this.e, cVar.e) && Intrinsics.b(this.f, cVar.f) && Intrinsics.b(this.g, cVar.g) && Intrinsics.b(this.h, cVar.h) && this.i == cVar.i && this.j == cVar.j && Intrinsics.b(this.k, cVar.k) && this.l == cVar.l;
    }
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("LoggedOut(name=");
        sb.append(this.d);
