...
public final class f extends b {
    ...
    public final void c(d item) {
        ...
        String string = context.getString(R.string.page_number, objArr);
        Intrinsics.checkNotNullExpressionValue(string, "getString(...)");
        String string2 = context.getString(R.string.exercise_group_row_title, string, item.c);
        ...
        this.itemView.setOnClickListener(new com.braze.ui.inappmessage.d(item, 21));
    }
}
