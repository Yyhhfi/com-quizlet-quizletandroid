...
public abstract class Hilt_ChapterMenuFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            chapterMenuFragment.a = jVar.d.a();
            chapterMenuFragment.b = jVar.b.S0();
            chapterMenuFragment.j = new com.google.firebase.perf.logging.b(25);
        }
    }
