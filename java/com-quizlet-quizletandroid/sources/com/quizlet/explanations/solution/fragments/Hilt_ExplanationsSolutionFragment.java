...
public abstract class Hilt_ExplanationsSolutionFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            ExplanationsSolutionFragment explanationsSolutionFragment = (ExplanationsSolutionFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((d) d());
            C4622e c4622e = jVar.d;
            explanationsSolutionFragment.a = c4622e.a();
            explanationsSolutionFragment.b = jVar.b.S0();
            explanationsSolutionFragment.n = (com.quizlet.explanations.navigation.b) c4622e.X.get();
            explanationsSolutionFragment.o = new u(25);
            explanationsSolutionFragment.p = new assistantMode.utils.studiableMetadata.b(25);
            explanationsSolutionFragment.q = new retrofit2.adapter.rxjava3.d(24);
        }
    }
