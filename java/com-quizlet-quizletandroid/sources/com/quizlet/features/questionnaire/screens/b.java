...
public abstract class b {
    public static final void a(com.quizlet.features.questionnaire.steps.a viewModel, q qVar, InterfaceC0806l interfaceC0806l, int i) {
        int i2;
        ...
        if ((i2 & 19) == 18 && c0814p.x()) {
            ...
            int i5 = i2;
            Q4.b("Exams Screen", null, C0861v.b, S5.g(24), null, 0L, null, 0L, 0, false, 0, 0, null, null, c0814p, 3462, 0, 131058);
            c0814p = c0814p;
            ...
            if (zF || objI == C0804k.a) {
                objI = new com.quizlet.data.repository.explanations.exercise.a(29, viewModel, button);
                c0814p.i0(objI);
            }
            c0814p.p(false);
            Z1.b((Function0) objI, AbstractC0382e.y(nVar, DefinitionKt.NO_Float_VALUE, 24, DefinitionKt.NO_Float_VALUE, DefinitionKt.NO_Float_VALUE, 13), false, null, null, null, null, null, null, androidx.compose.runtime.internal.e.e(-660933627, new a(button), c0814p), c0814p, 805306416, 508);
            c0814p.p(true);
            c0814p.p(true);
        }
        C0813o0 c0813o0R = c0814p.r();
        if (c0813o0R != null) {
            c0813o0R.d = new com.quizlet.assembly.compose.progress.a(viewModel, qVar, i, 17);
        }
    }
}
