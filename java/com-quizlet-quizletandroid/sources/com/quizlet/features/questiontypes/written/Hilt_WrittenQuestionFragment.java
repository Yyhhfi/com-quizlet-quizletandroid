...
public abstract class Hilt_WrittenQuestionFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            writtenQuestionFragment.a = jVar.d.a();
            writtenQuestionFragment.b = jVar.b.S0();
        }
    }
