...
public abstract class Hilt_MultipleChoiceQuestionFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            multipleChoiceQuestionFragment.a = jVar.d.a();
            multipleChoiceQuestionFragment.b = jVar.b.S0();
        }
    }
