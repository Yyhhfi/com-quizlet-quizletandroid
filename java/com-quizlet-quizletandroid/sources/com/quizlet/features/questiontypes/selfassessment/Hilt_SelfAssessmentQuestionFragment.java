...
public abstract class Hilt_SelfAssessmentQuestionFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            selfAssessmentQuestionFragment.a = jVar.d.a();
            selfAssessmentQuestionFragment.b = jVar.b.S0();
        }
    }
