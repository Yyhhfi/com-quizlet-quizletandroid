...
public abstract class Hilt_FillInTheBlankQuestionFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            FillInTheBlankQuestionFragment fillInTheBlankQuestionFragment = (FillInTheBlankQuestionFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((f) d());
            fillInTheBlankQuestionFragment.a = jVar.d.a();
            fillInTheBlankQuestionFragment.b = jVar.b.S0();
        }
    }
