...
public abstract class Hilt_TrueFalseQuestionFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            trueFalseQuestionFragment.a = jVar.d.a();
            trueFalseQuestionFragment.b = jVar.b.S0();
        }
    }
