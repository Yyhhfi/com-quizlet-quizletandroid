...
public final class j extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) throws Exception {
        ...
        if (i == 0) {
            Z.e(obj);
            l lVar = this.k;
            com.quizlet.quizletandroid.ui.studymodes.questionTypes.managers.a aVar2 = lVar.b;
            DBAnswer dBAnswer = lVar.r;
            if (dBAnswer == null) {
                Intrinsics.m("answer");
                throw null;
            }
            List listC = aVar2.c(dBAnswer, lVar.i, lVar.g);
            DBAnswer dBAnswer2 = lVar.r;
            if (dBAnswer2 == null) {
                Intrinsics.m("answer");
                throw null;
            }
