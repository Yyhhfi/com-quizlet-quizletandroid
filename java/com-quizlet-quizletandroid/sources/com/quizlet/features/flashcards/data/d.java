...
public final class d extends N {
    ...
    public d(boolean z, C4242p primaryCtaOnClick, C4242p secondaryCtaOnClick, com.quizlet.explanations.textbook.ui.f linearProgressEvent) {
        super(R.drawable.img_fc_complete, new n(R.string.flashcards_summary_learn_cta, primaryCtaOnClick, z ? new C4089n(linearProgressEvent) : C4090o.a, c.b), new n(R.string.flashcards_next_steps_restart_title, 12, secondaryCtaOnClick), null);
        ...
        this.i = R.string.flashcards_summary_sorted_complete_header;
