...
public final class y extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public y(S s, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = s;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            Z.e(obj);
            S s = this.k;
            com.quizlet.features.flashcards.helpers.d dVar = (com.quizlet.features.flashcards.helpers.d) s.e.c;
            x xVar = new x(s, 0);
            this.j = 1;
            if (dVar.b(xVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
