...
public abstract class Hilt_UserProfileFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            userProfileFragment.a = c4622e.a();
            userProfileFragment.b = jVar.b.S0();
            userProfileFragment.j = c4622e.d();
        }
    }
