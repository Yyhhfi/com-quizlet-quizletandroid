...
public final class k extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public k(m mVar, com.quizlet.features.folders.addtofolder.data.n nVar, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = mVar;
        this.l = nVar;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            Z.e(obj);
            o oVar = ((com.quizlet.features.folders.addtofolder.data.a) this.l).a;
            this.j = 1;
            if (m.C(this.k, oVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
