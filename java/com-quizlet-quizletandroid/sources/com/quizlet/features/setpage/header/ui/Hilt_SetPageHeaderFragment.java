...
public abstract class Hilt_SetPageHeaderFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            setPageHeaderFragment.a = jVar.d.a();
            setPageHeaderFragment.b = jVar.b.S0();
            setPageHeaderFragment.j = (SetPagePerformanceLogger) jVar.c.i.get();
        }
    }
