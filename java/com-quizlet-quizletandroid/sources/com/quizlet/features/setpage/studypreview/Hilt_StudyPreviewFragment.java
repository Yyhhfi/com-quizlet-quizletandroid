...
public abstract class Hilt_StudyPreviewFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            studyPreviewFragment.a = jVar.d.a();
            studyPreviewFragment.b = jVar.b.S0();
        }
    }
