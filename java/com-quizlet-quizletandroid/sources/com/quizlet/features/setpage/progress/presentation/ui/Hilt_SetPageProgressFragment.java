...
public abstract class Hilt_SetPageProgressFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            setPageProgressFragment.a = jVar.d.a();
            setPageProgressFragment.b = jVar.b.S0();
        }
    }
