...
public abstract class Hilt_SelectedTermsModeFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            SelectedTermsModeFragment selectedTermsModeFragment = (SelectedTermsModeFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((c) d());
            selectedTermsModeFragment.a = jVar.d.a();
            selectedTermsModeFragment.b = jVar.b.S0();
        }
    }
