...
public final class h extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public h(n nVar, DBStudySet dBStudySet, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = nVar;
        this.l = dBStudySet;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Enum enumB = nVar.b(dBStudySet.getId(), dBStudySet.getPasswordEdit(), dBStudySet.getCreatorId(), this);
        return enumB == aVar ? aVar : enumB;
    }
}
