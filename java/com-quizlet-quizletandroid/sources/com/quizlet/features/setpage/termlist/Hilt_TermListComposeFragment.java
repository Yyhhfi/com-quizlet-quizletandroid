...
public abstract class Hilt_TermListComposeFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            TermListComposeFragment termListComposeFragment = (TermListComposeFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((d) d());
            termListComposeFragment.a = jVar.d.a();
            termListComposeFragment.b = jVar.b.S0();
            termListComposeFragment.j = new com.google.mlkit.common.sdkinternal.b(24);
        }
    }
