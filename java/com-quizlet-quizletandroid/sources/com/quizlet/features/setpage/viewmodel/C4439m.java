...
/* renamed from: com.quizlet.features.setpage.viewmodel.m, reason: case insensitive filesystem */
/* loaded from: classes3.dex */
public final class C4439m extends kotlin.coroutines.jvm.internal.i implements Function1 {
    public int j;
    public final /* synthetic */ kotlin.coroutines.jvm.internal.i k;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public C4439m(Function1 function1, kotlin.coroutines.h hVar) {
        super(1, hVar);
    ...
    public final kotlin.coroutines.h create(kotlin.coroutines.h hVar) {
        return new C4439m(this.k, hVar);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Object obj) {
        return ((C4439m) create((kotlin.coroutines.h) obj)).invokeSuspend(Unit.a);
    }
