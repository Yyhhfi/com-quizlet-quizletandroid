...
public final class UploadNotesActivity extends c implements dagger.hilt.internal.b {
    ...
    public UploadNotesActivity() {
        addOnContextAvailableListener(new C0054j(this, 12));
    }
    ...
    public final void onCreate(Bundle bundle) {
        B(bundle);
        v.b(this, null, 3);
        j.a(this, new d(true, 514103958, new a(this, 1)));
    }
