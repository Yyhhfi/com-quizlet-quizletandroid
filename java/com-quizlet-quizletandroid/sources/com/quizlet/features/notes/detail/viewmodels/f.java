...
public final class f extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public f(v vVar, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = vVar;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            Z.e(obj);
            com.quizlet.features.notes.data.c cVar = new com.quizlet.features.notes.data.c(false, com.quizlet.features.notes.data.b.a);
            this.j = 1;
            if (this.k.G(cVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
