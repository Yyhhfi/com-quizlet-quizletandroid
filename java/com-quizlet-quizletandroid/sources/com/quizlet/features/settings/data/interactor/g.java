...
public final class g extends kotlin.coroutines.jvm.internal.i implements Function1 {
    ...
    public g(com.quizlet.data.repository.qclass.c cVar, String str, String str2, kotlin.coroutines.h hVar) {
        super(1, hVar);
        this.k = cVar;
        this.l = str;
        this.m = str2;
