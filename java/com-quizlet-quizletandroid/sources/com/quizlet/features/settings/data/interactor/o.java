...
public final class o extends kotlin.coroutines.jvm.internal.i implements Function1 {
    ...
    public o(com.quizlet.data.repository.qclass.c cVar, String str, kotlin.coroutines.h hVar) {
        super(1, hVar);
        this.k = cVar;
        this.l = str;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            dVar.getClass();
            io.reactivex.rxjava3.internal.operators.single.g gVarE = dVar.d.c(new ReauthenticationRequest(null, null, this.l)).l(dVar.b).h(dVar.c).e(new com.quizlet.quizletandroid.ui.usersettings.b(dVar, 0)).e(new com.quizlet.quizletandroid.ui.setcreation.imageupload.a(7));
            this.j = 1;
            obj = I1.b(gVarE, this);
            if (obj == aVar) {
                return aVar;
