...
public final class e extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public e(OnboardingSurveyActivity onboardingSurveyActivity, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            d dVar = new d(onboardingSurveyActivity, null);
            this.j = 1;
            if (p0.m(onboardingSurveyActivity, b, dVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
