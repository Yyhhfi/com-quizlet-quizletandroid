...
public final class j extends a {
    ...
    public j(L l, Y homeScrollDelegate) {
    ...
    public final int getItemViewType(int i) {
        ...
        if (!(abstractC4707c instanceof A)) {
    ...
    public final void onBindViewHolder(F0 f0, int i) {
        ...
        if (holder instanceof com.quizlet.quizletandroid.ui.startpage.nav2.viewholder.f) {
            ...
            Intrinsics.e(abstractC4707c, "null cannot be cast to non-null type com.quizlet.quizletandroid.ui.startpage.nav2.model.HorizontalMyExplanationsHomeData");
            A a = (A) abstractC4707c;
            ((com.quizlet.quizletandroid.ui.startpage.nav2.viewholder.i) holder).f(u.g, this.c, a.f(), new com.quizlet.features.setpage.header.ui.g(19, this, a));
            holder.itemView.setTag(R.id.unifiedRecyclerView, Boolean.valueOf(a.a));
        }
    }
