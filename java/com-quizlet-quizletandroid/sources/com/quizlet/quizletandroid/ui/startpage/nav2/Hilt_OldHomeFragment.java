...
public abstract class Hilt_OldHomeFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((InterfaceC4729t) d());
            C4622e c4622e = jVar.d;
            oldHomeFragment.a = c4622e.a();
            com.quizlet.quizletandroid.u uVar = jVar.b;
            oldHomeFragment.b = uVar.S0();
            oldHomeFragment.j = (com.quizlet.features.setpage.utils.setpermissions.a) uVar.h1.get();
            oldHomeFragment.k = (com.quizlet.infra.legacysyncengine.managers.d) uVar.Z.get();
            oldHomeFragment.l = (com.quizlet.offline.managers.b) uVar.d1.get();
            oldHomeFragment.m = c4622e.e();
            oldHomeFragment.n = new androidx.work.impl.model.l(new com.quizlet.infra.legacysyncengine.managers.g(c4622e.b.q()));
            oldHomeFragment.o = com.quizlet.featuregate.injection.a.j();
            oldHomeFragment.p = new com.quizlet.quizletandroid.logging.initializer.a(1);
            oldHomeFragment.q = com.quizlet.quizletandroid.ui.webpages.a.a;
            oldHomeFragment.r = new com.quizlet.quizletandroid.util.d();
            oldHomeFragment.s = new com.quizlet.quizletandroid.ui.debug.a();
        }
    }
