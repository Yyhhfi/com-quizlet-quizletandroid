...
import com.quizlet.quizletandroid.ui.startpage.nav2.model.D;
...
public final class o extends a {
    ...
    public o(Y setNavDelegate, Y homeScrollDelegate, Y studiableLoggingDelegate, com.quizlet.infra.legacysyncengine.managers.d loggedInUserManager) {
    ...
    public final int getItemViewType(int i) {
        ...
        if (!(abstractC4707c instanceof C)) {
    ...
    public final void onBindViewHolder(F0 f0, int i) {
        ...
        if (holder instanceof com.quizlet.quizletandroid.ui.startpage.nav2.viewholder.i) {
            Intrinsics.e(abstractC4707c, "null cannot be cast to non-null type com.quizlet.quizletandroid.ui.startpage.nav2.model.HorizontalRecommendationStudySetHomeData");
            C c = (C) abstractC4707c;
            int i2 = 0;
            if (!(c instanceof x)) {
                if (c instanceof D) {
                    i2 = ((D) abstractC4707c).f;
            ...
            Object rVar = map.get(numValueOf);
            if (rVar == null) {
                rVar = new r(this.c, this.e, this.f, i2);
                map.put(numValueOf, rVar);
            }
            ((com.quizlet.quizletandroid.ui.startpage.nav2.viewholder.i) holder).f(AbstractC3595c6.b(abstractC4707c), this.d, i2, new com.quizlet.features.setpage.header.ui.g(22, (r) rVar, abstractC4707c));
            holder.itemView.setTag(R.id.unifiedRecyclerView, Boolean.valueOf(c.a));
        }
    }
