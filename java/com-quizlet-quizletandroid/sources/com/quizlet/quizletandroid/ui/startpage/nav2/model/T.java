...
public final class T extends AbstractC3603d6 {
    public final String a;

    public T(String sourceName) {
    ...
    public final String toString() {
        return android.support.v4.media.session.a.t(new StringBuilder("UserSourceRecommendation(sourceName="), this.a, ")");
    }
}
