...
public final class h extends a {
    ...
    public h(L l, Y homeScrollDelegate, Y studiableLoggingDelegate) {
        ...
        this.d = new g(l, studiableLoggingDelegate, 0);
    }
    ...
    public final int getItemViewType(int i) {
        ...
        if (!(abstractC4707c instanceof z)) {
    ...
    public final void onBindViewHolder(F0 f0, int i) {
        ...
        if (holder instanceof com.quizlet.quizletandroid.ui.startpage.nav2.viewholder.f) {
            ...
            Intrinsics.e(abstractC4707c, "null cannot be cast to non-null type com.quizlet.quizletandroid.ui.startpage.nav2.model.HorizontalGroupHomeData");
            z zVar = (z) abstractC4707c;
            ((com.quizlet.quizletandroid.ui.startpage.nav2.viewholder.i) holder).f(u.f, this.c, zVar.f(), new com.quizlet.features.setpage.header.ui.g(18, this, zVar));
            holder.itemView.setTag(R.id.unifiedRecyclerView, Boolean.valueOf(zVar.a));
        }
    }
