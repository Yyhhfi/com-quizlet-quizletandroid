...
public final class l extends a {
    ...
    public l(L l, Y homeScrollDelegate, Y studiableLoggingDelegate) {
        ...
        this.d = new g(l, studiableLoggingDelegate, 2);
    }
    ...
    public final int getItemViewType(int i) {
        ...
        if (!(abstractC4707c instanceof B)) {
    ...
    public final void onBindViewHolder(F0 f0, int i) {
        ...
        if (holder instanceof com.quizlet.quizletandroid.ui.startpage.nav2.viewholder.f) {
            ...
            Intrinsics.e(abstractC4707c, "null cannot be cast to non-null type com.quizlet.quizletandroid.ui.startpage.nav2.model.HorizontalNoteHomeData");
            B b = (B) abstractC4707c;
            ((com.quizlet.quizletandroid.ui.startpage.nav2.viewholder.i) holder).f(u.h, this.c, b.f(), new com.quizlet.features.setpage.header.ui.g(21, this, b));
            holder.itemView.setTag(R.id.unifiedRecyclerView, Boolean.valueOf(b.a));
        }
    }
