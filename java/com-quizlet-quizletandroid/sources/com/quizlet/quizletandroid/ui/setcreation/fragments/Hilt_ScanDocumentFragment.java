...
public abstract class Hilt_ScanDocumentFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            scanDocumentFragment.a = jVar.d.a();
            u uVar = jVar.b;
            scanDocumentFragment.b = uVar.S0();
            com.quizlet.quizletandroid.ui.common.images.capture.a imageCache = new com.quizlet.quizletandroid.ui.common.images.capture.a();
            Intrinsics.checkNotNullParameter(imageCache, "imageCache");
            scanDocumentFragment.j = new androidx.camera.camera2.internal.concurrent.a(imageCache);
            scanDocumentFragment.k = new com.quizlet.quizletandroid.ui.common.images.capture.a();
            scanDocumentFragment.l = new androidx.camera.camera2.internal.compat.workaround.e(16, false);
            scanDocumentFragment.m = (com.quizlet.quizletandroid.ui.setcreation.tracking.c) jVar.e.get();
        }
    }
