...
public abstract class Hilt_MatchEndGameFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            matchEndGameFragment.a = jVar.d.a();
            com.quizlet.quizletandroid.u uVar = jVar.b;
            matchEndGameFragment.b = uVar.S0();
            matchEndGameFragment.j = (com.quizlet.quizletandroid.util.f) uVar.a0.get();
        }
    }
