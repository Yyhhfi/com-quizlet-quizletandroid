...
public abstract class Hilt_LearnCheckpointFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            learnCheckpointFragment.a = jVar.d.a();
            com.quizlet.quizletandroid.u uVar = jVar.b;
            learnCheckpointFragment.b = uVar.S0();
            learnCheckpointFragment.j = (com.quizlet.qutils.image.loading.a) uVar.s.get();
            learnCheckpointFragment.k = (com.quizlet.quizletandroid.managers.audio.h) uVar.f0.get();
        }
    }
