...
public abstract class Hilt_StandardMatchGameFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((u) d());
            standardMatchGameFragment.a = jVar.d.a();
            com.quizlet.quizletandroid.u uVar = jVar.b;
            standardMatchGameFragment.b = uVar.S0();
            standardMatchGameFragment.j = (com.quizlet.qutils.image.loading.a) uVar.s.get();
            standardMatchGameFragment.k = (com.quizlet.quizletandroid.managers.audio.h) uVar.f0.get();
            standardMatchGameFragment.l = uVar.g();
            standardMatchGameFragment.m = (com.quizlet.richtext.rendering.c) uVar.o0.get();
            standardMatchGameFragment.n = (com.quizlet.quizletandroid.util.f) uVar.a0.get();
        }
    }
