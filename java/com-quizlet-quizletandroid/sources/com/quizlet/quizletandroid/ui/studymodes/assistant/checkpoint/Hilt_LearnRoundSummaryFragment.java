...
public abstract class Hilt_LearnRoundSummaryFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((r) d());
            learnRoundSummaryFragment.a = jVar.d.a();
            learnRoundSummaryFragment.b = jVar.b.S0();
        }
    }
