...
public abstract class Hilt_TestModeResultsFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            testModeResultsFragment.a = jVar.d.a();
            testModeResultsFragment.b = jVar.b.S0();
        }
    }
