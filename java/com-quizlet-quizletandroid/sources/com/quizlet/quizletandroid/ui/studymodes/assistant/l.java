...
public final class l extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public l(LearningAssistantActivity learningAssistantActivity, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            k kVar = new k(learningAssistantActivity, null);
            this.j = 1;
            if (p0.m(learningAssistantActivity, b, kVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
