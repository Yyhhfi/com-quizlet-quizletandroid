...
public abstract class Hilt_MatchSettingsFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            matchSettingsFragment.a = c4622e.a();
            matchSettingsFragment.b = jVar.b.S0();
            EventLogger eventLogger = (EventLogger) c4622e.b.l0.get();
            Intrinsics.checkNotNullParameter(eventLogger, "eventLogger");
            com.onetrust.otpublishers.headless.UI.TVUI.datautils.a aVar = new com.onetrust.otpublishers.headless.UI.TVUI.datautils.a();
            aVar.b = eventLogger;
            aVar.g = l.b(new com.quizlet.quizletandroid.ui.studymodes.assistant.settings.grading.a(aVar, 5));
            matchSettingsFragment.j = aVar;
        }
    }
