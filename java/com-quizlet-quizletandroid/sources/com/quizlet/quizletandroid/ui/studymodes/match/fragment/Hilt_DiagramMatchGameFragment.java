...
public abstract class Hilt_DiagramMatchGameFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            diagramMatchGameFragment.a = jVar.d.a();
            com.quizlet.quizletandroid.u uVar = jVar.b;
            diagramMatchGameFragment.b = uVar.S0();
            diagramMatchGameFragment.j = (com.quizlet.qutils.image.loading.a) uVar.s.get();
            diagramMatchGameFragment.k = (com.quizlet.quizletandroid.managers.audio.h) uVar.f0.get();
            diagramMatchGameFragment.l = uVar.g();
            diagramMatchGameFragment.m = (com.quizlet.richtext.rendering.c) uVar.o0.get();
            diagramMatchGameFragment.n = (com.quizlet.quizletandroid.util.f) uVar.a0.get();
            diagramMatchGameFragment.o = com.quizlet.featuregate.injection.a.j();
        }
    }
