...
public abstract class Hilt_TestModeStartFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            TestModeStartFragment testModeStartFragment = (TestModeStartFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((o) d());
            testModeStartFragment.a = jVar.d.a();
            testModeStartFragment.b = jVar.b.S0();
        }
    }
