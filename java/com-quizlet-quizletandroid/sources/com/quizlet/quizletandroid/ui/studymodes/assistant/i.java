...
public final class i extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public i(LearningAssistantActivity learningAssistantActivity, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            h hVar = new h(learningAssistantActivity, null);
            this.j = 1;
            if (p0.m(learningAssistantActivity, b, hVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
