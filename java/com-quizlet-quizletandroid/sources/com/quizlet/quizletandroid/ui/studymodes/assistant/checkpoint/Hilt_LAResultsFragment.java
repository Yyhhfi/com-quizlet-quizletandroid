...
public abstract class Hilt_LAResultsFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            lAResultsFragment.a = jVar.d.a();
            com.quizlet.quizletandroid.u uVar = jVar.b;
            lAResultsFragment.b = uVar.S0();
            lAResultsFragment.j = (com.quizlet.infra.legacysyncengine.managers.d) uVar.Z.get();
            lAResultsFragment.k = (EventLogger) uVar.l0.get();
        }
    }
