...
public abstract class Hilt_MatchGameFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            matchGameFragment.a = jVar.d.a();
            matchGameFragment.b = jVar.b.S0();
        }
    }
