...
public abstract class Hilt_LibraryFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((InterfaceC4670o) d());
            C4622e c4622e = jVar.d;
            libraryFragment.a = c4622e.a();
            com.quizlet.quizletandroid.u uVar = jVar.b;
            libraryFragment.b = uVar.S0();
            libraryFragment.j = (com.quizlet.offline.managers.b) uVar.d1.get();
            libraryFragment.m = (com.quizlet.explanations.navigation.b) c4622e.X.get();
        }
    }
