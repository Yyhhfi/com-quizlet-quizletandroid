...
public final class T extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public T(c0 c0Var, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = c0Var;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            d0 d0Var = this.k.u;
            com.quizlet.quizletandroid.ui.library.data.x xVar = com.quizlet.quizletandroid.ui.library.data.x.a;
            this.j = 1;
            if (d0Var.emit(xVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
