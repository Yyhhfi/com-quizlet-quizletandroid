...
public final class W extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public W(c0 c0Var, String str, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = c0Var;
        this.l = str;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            d0 d0Var = this.k.u;
            com.quizlet.quizletandroid.ui.library.data.u uVar = new com.quizlet.quizletandroid.ui.library.data.u(this.l);
            this.j = 1;
            if (d0Var.emit(uVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
