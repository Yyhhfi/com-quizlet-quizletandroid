...
public final class a0 extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public a0(c0 c0Var, String str, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = c0Var;
        this.l = str;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            d0 d0Var = this.k.u;
            com.quizlet.quizletandroid.ui.library.data.D d = new com.quizlet.quizletandroid.ui.library.data.D(this.l);
            this.j = 1;
            if (d0Var.emit(d, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
