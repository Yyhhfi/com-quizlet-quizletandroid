...
public abstract class Hilt_ActivityCenterFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            activityCenterFragment.a = jVar.d.a();
            activityCenterFragment.b = jVar.b.S0();
        }
    }
