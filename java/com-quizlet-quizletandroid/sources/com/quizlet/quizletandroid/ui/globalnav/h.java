...
public final class h extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public h(GlobalNavigationActivity globalNavigationActivity, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            g gVar = new g(globalNavigationActivity, null);
            this.j = 1;
            if (p0.m(globalNavigationActivity, b, gVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
