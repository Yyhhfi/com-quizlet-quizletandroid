...
public final class f extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public f(GlobalNavigationActivity globalNavigationActivity, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            e eVar = new e(globalNavigationActivity, null);
            this.j = 1;
            if (p0.m(globalNavigationActivity, b, eVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
