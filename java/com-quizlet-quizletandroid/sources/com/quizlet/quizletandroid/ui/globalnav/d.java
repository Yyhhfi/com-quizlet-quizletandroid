...
public final class d extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public d(GlobalNavigationActivity globalNavigationActivity, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            c cVar = new c(globalNavigationActivity, null);
            this.j = 1;
            if (p0.m(globalNavigationActivity, b, cVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
