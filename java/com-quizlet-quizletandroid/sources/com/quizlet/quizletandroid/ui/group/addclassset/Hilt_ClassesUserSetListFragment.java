...
abstract class Hilt_ClassesUserSetListFragment extends AddToClassSetListFragment implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j B;
    public boolean C;
    ...
    public final void d0() {
        if (e0(getHost()) && !this.F) {
            ...
            classesUserSetListFragment.a = jVar.d.a();
            u uVar = jVar.b;
            classesUserSetListFragment.b = uVar.S0();
            classesUserSetListFragment.x = uVar.e1();
        }
    }
