...
abstract class Hilt_CreatedUserSetListFragment extends AddToClassSetListFragment implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j B;
    public boolean C;
    ...
    public final void d0() {
        if (e0(getHost()) && !this.F) {
            this.F = true;
            CreatedUserSetListFragment createdUserSetListFragment = (CreatedUserSetListFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((f) d());
            createdUserSetListFragment.a = jVar.d.a();
            u uVar = jVar.b;
            createdUserSetListFragment.b = uVar.S0();
            createdUserSetListFragment.x = uVar.e1();
        }
    }
