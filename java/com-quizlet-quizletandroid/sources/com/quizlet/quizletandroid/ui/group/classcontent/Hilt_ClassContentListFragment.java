...
public abstract class Hilt_ClassContentListFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            classContentListFragment.a = jVar.d.a();
            u uVar = jVar.b;
            classContentListFragment.b = uVar.S0();
            classContentListFragment.j = (com.quizlet.offline.managers.b) uVar.d1.get();
        }
    }
