...
public abstract class Hilt_UserBirthdayFragment extends BaseSignupFragment implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void a0() {
        if (b0(getHost()) && !this.u) {
            ...
            userBirthdayFragment.a = jVar.d.a();
            com.quizlet.quizletandroid.u uVar = jVar.b;
            userBirthdayFragment.b = uVar.S0();
            userBirthdayFragment.e = (com.quizlet.quizletandroid.managers.g) uVar.Z0.get();
            userBirthdayFragment.f = com.quizlet.featuregate.injection.a.j();
            userBirthdayFragment.g = new androidx.work.impl.model.v(uVar.g1(), com.quizlet.quizletandroid.u.v());
            userBirthdayFragment.h = uVar.f1();
            userBirthdayFragment.i = com.quizlet.time.b.a;
            userBirthdayFragment.j = com.quizlet.qutils.string.c.a;
            userBirthdayFragment.k = com.quizlet.uicommon.util.tooltip.a.a;
            userBirthdayFragment.v = uVar.O();
        }
    }
