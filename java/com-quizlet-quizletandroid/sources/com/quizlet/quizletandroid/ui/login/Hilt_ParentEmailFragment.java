...
public abstract class Hilt_ParentEmailFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((w) d());
            parentEmailFragment.a = jVar.d.a();
            parentEmailFragment.b = jVar.b.S0();
            parentEmailFragment.j = com.quizlet.featuregate.injection.a.j();
        }
    }
