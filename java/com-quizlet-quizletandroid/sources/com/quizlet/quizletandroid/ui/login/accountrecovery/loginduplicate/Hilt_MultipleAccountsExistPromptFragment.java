...
public abstract class Hilt_MultipleAccountsExistPromptFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            MultipleAccountsExistPromptFragment multipleAccountsExistPromptFragment = (MultipleAccountsExistPromptFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((c) d());
            multipleAccountsExistPromptFragment.a = jVar.d.a();
            multipleAccountsExistPromptFragment.b = jVar.b.S0();
        }
    }
