...
public abstract class Hilt_AccountAlreadyExistsPromptFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            accountAlreadyExistsPromptFragment.a = jVar.d.a();
            u uVar = jVar.b;
            accountAlreadyExistsPromptFragment.b = uVar.S0();
            accountAlreadyExistsPromptFragment.j = uVar.O();
        }
    }
