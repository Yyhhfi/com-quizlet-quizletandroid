...
public final class k extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public k(p pVar, boolean z, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = pVar;
        this.l = z;
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        boolean z = this.l;
        com.quizlet.local.cache.e eVar = ((com.quizlet.local.cache.caches.a) hVar.d).d;
        eVar.getClass();
        Object objJ = (AbstractC4128g) eVar.get(Unit.a);
        if (objJ == null || z) {
            objJ = E.J((AbstractC5040y) hVar.c, new com.quizlet.data.repository.achievements.d(hVar, null), this);
        }
