...
public abstract /* synthetic */ class b {
    ...
    static {
        ...
        try {
            iArr[EnumC4479f.DAILY_STREAKS.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            iArr[EnumC4479f.WEEK.ordinal()] = 3;
        ...
        try {
            iArr[EnumC4479f.SETS_STUDIED.ordinal()] = 5;
        } catch (NoSuchFieldError unused5) {
        }
        try {
            iArr[EnumC4479f.ROUNDS_STUDIED.ordinal()] = 6;
        } catch (NoSuchFieldError unused6) {
        }
        try {
            iArr[EnumC4479f.EXPLANATIONS_STUDIED.ordinal()] = 7;
        } catch (NoSuchFieldError unused7) {
        }
        try {
            iArr[EnumC4479f.NONE.ordinal()] = 8;
