...
public final class k extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public k(androidx.work.impl.model.c cVar, long j, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = cVar;
        this.l = j;
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        Z.e(obj);
        io.reactivex.rxjava3.internal.operators.single.g gVarC = AbstractC3770y6.c(new z0(1, (com.quizlet.data.repository.folder.i) this.k.b, com.quizlet.data.repository.folder.i.class, "deleteFolders", "deleteFolders(Ljava/util/List;)Lio/reactivex/rxjava3/core/Single;", 0, 10), Long.valueOf(this.l));
        this.j = 1;
