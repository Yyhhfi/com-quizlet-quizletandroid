...
public final class OutlineMarkdownInfoJsonAdapter extends com.squareup.moshi.l {
    ...
    public OutlineMarkdownInfoJsonAdapter(@NotNull com.squareup.moshi.D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        com.airbnb.lottie.parser.moshi.c cVarB = com.airbnb.lottie.parser.moshi.c.b("uuid", "status", "outline");
        ...
        this.c = lVarA2;
        com.squareup.moshi.l lVarA3 = moshi.a(String.class, m, "outline");
    ...
    public final Object a(com.squareup.moshi.p reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (i == -5) {
            ...
            if (enumC4175w != null) {
                return new OutlineMarkdownInfo(str, enumC4175w, str2);
            }
            throw com.squareup.moshi.internal.b.e("status", "status", reader);
        }
        Constructor declaredConstructor = this.e;
        if (declaredConstructor == null) {
            declaredConstructor = OutlineMarkdownInfo.class.getDeclaredConstructor(String.class, EnumC4175w.class, String.class, Integer.TYPE, com.squareup.moshi.internal.b.c);
        ...
        return (OutlineMarkdownInfo) objNewInstance;
    }
    ...
    public final String toString() {
        return AbstractC4178x.m(41, "GeneratedJsonAdapter(OutlineMarkdownInfo)", "toString(...)");
    }
}
