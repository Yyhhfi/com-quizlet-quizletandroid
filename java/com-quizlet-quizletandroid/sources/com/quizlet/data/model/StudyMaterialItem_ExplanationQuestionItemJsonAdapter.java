...
public final class StudyMaterialItem_ExplanationQuestionItemJsonAdapter extends com.squareup.moshi.l {
    public final com.airbnb.lottie.parser.moshi.c a;
    public final com.squareup.moshi.l b;
    public final com.squareup.moshi.l c;

    public StudyMaterialItem_ExplanationQuestionItemJsonAdapter(@NotNull com.squareup.moshi.D moshi) {
        ...
        this.b = lVarA;
        com.squareup.moshi.l lVarA2 = moshi.a(Question.class, m, "data");
    ...
    public final Object a(com.squareup.moshi.p reader) {
        ...
        while (reader.l()) {
            ...
            } else if (iK0 == 1 && (question = (Question) this.c.a(reader)) == null) {
        ...
        if (question != null) {
            return new StudyMaterialItem$ExplanationQuestionItem(m1, question);
        }
    ...
    public final void g(com.squareup.moshi.w writer, Object obj) {
        ...
        this.b.g(writer, studyMaterialItem$ExplanationQuestionItem.a);
        writer.l("data");
        this.c.g(writer, studyMaterialItem$ExplanationQuestionItem.b);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(63, "GeneratedJsonAdapter(StudyMaterialItem.ExplanationQuestionItem)", "toString(...)");
    }
}
