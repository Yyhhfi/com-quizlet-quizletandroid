...
public final class TitleInfoJsonAdapter extends com.squareup.moshi.l {
    ...
    public TitleInfoJsonAdapter(@NotNull com.squareup.moshi.D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        com.airbnb.lottie.parser.moshi.c cVarB = com.airbnb.lottie.parser.moshi.c.b("uuid", "status", "title");
    ...
    public final Object a(com.squareup.moshi.p reader) throws IllegalAccessException, NoSuchMethodException, InstantiationException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (i == -5) {
            ...
            if (enumC4175w != null) {
                return new TitleInfo(str, enumC4175w, str2);
            }
            throw com.squareup.moshi.internal.b.e("status", "status", reader);
        }
        Constructor declaredConstructor = this.e;
        if (declaredConstructor == null) {
            declaredConstructor = TitleInfo.class.getDeclaredConstructor(String.class, EnumC4175w.class, String.class, Integer.TYPE, com.squareup.moshi.internal.b.c);
        ...
        return (TitleInfo) objNewInstance;
    }
    ...
    public final String toString() {
        return AbstractC4178x.m(31, "GeneratedJsonAdapter(TitleInfo)", "toString(...)");
    }
}
