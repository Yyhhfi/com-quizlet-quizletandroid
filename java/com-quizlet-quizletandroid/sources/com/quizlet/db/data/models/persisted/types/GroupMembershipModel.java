...
public final class GroupMembershipModel extends ModelType<DBGroupMembership> {
    ...
    @NotNull
    private final k mIdentityFields$delegate = l.b(new r(27));
    ...
    public static final Set mIdentityFields_delegate$lambda$0() {
        Relationship[] elements = {DBGroupMembershipFields.USER, DBGroupMembershipFields.CLASS};
    ...
    public ModelField<DBGroupMembership, Long> getLocalIdField() {
        ModelField<DBGroupMembership, Long> LOCAL_ID = DBGroupMembershipFields.LOCAL_ID;
    ...
    @Override // com.quizlet.db.data.models.persisted.base.ModelType
    public List<DBGroupMembership> getModels(@NotNull ModelWrapper modelWrapper) {
