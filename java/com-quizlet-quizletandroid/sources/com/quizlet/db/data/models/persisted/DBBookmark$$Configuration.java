...
public final class DBBookmark$$Configuration {
    public static List<DatabaseFieldConfig> getFieldConfigs() {
        ...
        DatabaseFieldConfig databaseFieldConfigC = AbstractC4178x.c(databaseFieldConfig, 2, arrayList, databaseFieldConfig, "folderId");
        databaseFieldConfigC.setColumnName("folderId");
    ...
    public static DatabaseTableConfig<DBBookmark> getTableConfig() {
        DatabaseTableConfig<DBBookmark> databaseTableConfigG = AbstractC4178x.g(DBBookmark.class, DBBookmark.TABLE_NAME);
