...
public class Migration0068AddIsVerifiedColumnToUser extends e {
    ...
    public final void b(AbstractC0772a abstractC0772a) throws SQLException {
        ...
        a aVar = a.d;
        cVar.o(DBUser.class, "user", DBUserFields.Names.IS_VERIFIED, aVar);
        cVar.o(DBUser.class, "user", DBUserFields.Names.IS_ADMIN, aVar);
    }
}
