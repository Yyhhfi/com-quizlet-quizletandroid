...
public final class i extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public i(MagicLinkLogOutDialogFragment magicLinkLogOutDialogFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            J viewLifecycleOwner = magicLinkLogOutDialogFragment.getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner, "getViewLifecycleOwner(...)");
            B b = B.c;
            h hVar = new h(magicLinkLogOutDialogFragment, null);
            this.j = 1;
            if (p0.m(viewLifecycleOwner, b, hVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
