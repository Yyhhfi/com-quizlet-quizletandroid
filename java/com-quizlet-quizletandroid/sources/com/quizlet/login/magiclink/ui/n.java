...
public final class n extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public n(MagicLinkSwitchAccountDialogFragment magicLinkSwitchAccountDialogFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            d0 d0Var = ((com.quizlet.login.magiclink.viewmodel.g) magicLinkSwitchAccountDialogFragment.v.getValue()).e;
            m mVar = new m(magicLinkSwitchAccountDialogFragment, null);
            this.j = 1;
            if (e0.i(d0Var, mVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
