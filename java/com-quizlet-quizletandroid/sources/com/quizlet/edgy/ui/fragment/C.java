...
public final class C extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public C(EdgyAddSchoolManuallyFragment edgyAddSchoolManuallyFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            B b2 = new B(edgyAddSchoolManuallyFragment, null);
            this.j = 1;
            if (p0.m(viewLifecycleOwner, b, b2, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
