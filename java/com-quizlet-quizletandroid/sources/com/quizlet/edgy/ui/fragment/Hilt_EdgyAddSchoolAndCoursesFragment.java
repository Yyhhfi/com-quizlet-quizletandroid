...
public abstract class Hilt_EdgyAddSchoolAndCoursesFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            EdgyAddSchoolAndCoursesFragment edgyAddSchoolAndCoursesFragment = (EdgyAddSchoolAndCoursesFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((s) d());
            edgyAddSchoolAndCoursesFragment.a = jVar.d.a();
            edgyAddSchoolAndCoursesFragment.b = jVar.b.S0();
        }
    }
