...
public final class E extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public E(EdgyAddSchoolManuallyFragment edgyAddSchoolManuallyFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            s0 s0Var = edgyAddSchoolManuallyFragment.U().g;
            D d = new D(edgyAddSchoolManuallyFragment, null);
            this.j = 1;
            if (e0.i(s0Var, d, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
