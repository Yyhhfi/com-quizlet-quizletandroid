...
public final class F extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public F(EdgyAddSchoolManuallyFragment edgyAddSchoolManuallyFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            E e = new E(edgyAddSchoolManuallyFragment, null);
            this.j = 1;
            if (p0.m(viewLifecycleOwner, b, e, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
