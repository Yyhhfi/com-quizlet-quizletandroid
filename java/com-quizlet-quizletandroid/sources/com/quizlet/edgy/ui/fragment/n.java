...
public final class n extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public n(EdgyAddSchoolAndCoursesFragment edgyAddSchoolAndCoursesFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C4199m c4199m = new C4199m(edgyAddSchoolAndCoursesFragment, null);
            this.j = 1;
            if (p0.m(viewLifecycleOwner, b, c4199m, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
