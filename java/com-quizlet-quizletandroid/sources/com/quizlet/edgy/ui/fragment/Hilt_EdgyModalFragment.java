...
public abstract class Hilt_EdgyModalFragment extends FullScreenConvertibleModalDialogFragment implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void a0() {
        if (b0(getHost()) && !this.H) {
            this.H = true;
            ((EdgyModalFragment) this).q = ((com.quizlet.quizletandroid.j) ((M) d())).d.a();
        }
    }
