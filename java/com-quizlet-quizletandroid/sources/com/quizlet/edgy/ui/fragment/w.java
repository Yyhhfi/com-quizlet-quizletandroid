...
public final class w extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public w(EdgyAddSchoolManuallyFragment edgyAddSchoolManuallyFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            v vVar = new v(edgyAddSchoolManuallyFragment, null);
            this.j = 1;
            if (p0.m(viewLifecycleOwner, b, vVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
