...
public final class A extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public A(EdgyAddSchoolManuallyFragment edgyAddSchoolManuallyFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (edgyAddSchoolManuallyFragment.m != null || list.isEmpty()) {
            return Unit.a;
        }
        ...
        edgyAddSchoolManuallyFragment.m = new ArrayAdapter(contextRequireContext, R.layout.item_dropdown, arrayList);
        com.quizlet.edgy.databinding.c cVar = (com.quizlet.edgy.databinding.c) edgyAddSchoolManuallyFragment.J();
        cVar.d.setAdapter(edgyAddSchoolManuallyFragment.m);
        return Unit.a;
    }
}
