...
public abstract class Hilt_EdgyAddCourseManuallyFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            EdgyAddCourseManuallyFragment edgyAddCourseManuallyFragment = (EdgyAddCourseManuallyFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((InterfaceC4191e) d());
            edgyAddCourseManuallyFragment.a = jVar.d.a();
            edgyAddCourseManuallyFragment.b = jVar.b.S0();
            edgyAddCourseManuallyFragment.j = new com.quizlet.edgy.utils.d();
        }
    }
