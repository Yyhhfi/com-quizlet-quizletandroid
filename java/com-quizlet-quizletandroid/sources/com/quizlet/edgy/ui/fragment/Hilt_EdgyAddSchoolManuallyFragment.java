...
public abstract class Hilt_EdgyAddSchoolManuallyFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            EdgyAddSchoolManuallyFragment edgyAddSchoolManuallyFragment = (EdgyAddSchoolManuallyFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((H) d());
            edgyAddSchoolManuallyFragment.a = jVar.d.a();
            edgyAddSchoolManuallyFragment.b = jVar.b.S0();
            edgyAddSchoolManuallyFragment.j = new com.quizlet.edgy.utils.d();
        }
    }
