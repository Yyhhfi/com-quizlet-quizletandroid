...
public final class b extends com.quizlet.baserecyclerview.c {
    ...
    public b(ConstraintLayout view, C4192f onClicked) {
        super(view);
    ...
    public final void c(Unit item) {
        ...
        if (listP == null || listP.isEmpty()) {
            string = context.getString(R.string.edgy_flow_add_new_school);
            Intrinsics.d(string);
        } else {
            Object[] array = AbstractC3058t1.b(context, listP).toArray(new Object[0]);
            string = context.getString(R.string.edgy_flow_add_new_school, Arrays.copyOf(array, array.length));
            Intrinsics.d(string);
        }
