...
public final class CountryJsonAdapter extends l {
    public final c a;
    public final l b;

    public CountryJsonAdapter(@NotNull D moshi) {
    ...
    public final void g(w writer, Object obj) {
        ...
        writer.l("code");
        l lVar = this.b;
        lVar.g(writer, country.a);
        writer.l("name");
        lVar.g(writer, country.b);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(29, "GeneratedJsonAdapter(Country)", "toString(...)");
    }
}
