...
public final class b extends i implements Function2 {
    ...
    public final Object invokeSuspend(Object obj) throws IOException {
        ...
        Z.e(obj);
        g gVar = this.j;
        InputStream inputStreamOpen = ((Context) gVar.b).getResources().getAssets().open("allCountries.json");
        ...
        try {
            ...
            Object value = ((u) gVar.e).getValue();
            Intrinsics.checkNotNullExpressionValue(value, "getValue(...)");
            AllCountries allCountries = (AllCountries) ((l) value).b(strB);
