...
public final class k extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public k(TermSearchFragment termSearchFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            J viewLifecycleOwner = termSearchFragment.getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner, "getViewLifecycleOwner(...)");
            B b = B.c;
            j jVar = new j(termSearchFragment, null);
            this.j = 1;
            if (p0.m(viewLifecycleOwner, b, jVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
