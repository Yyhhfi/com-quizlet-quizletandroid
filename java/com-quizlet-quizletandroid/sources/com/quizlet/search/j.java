...
public final class j extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public j(TermSearchFragment termSearchFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            Z.e(obj);
            String str = TermSearchFragment.V;
            TermSearchFragment termSearchFragment = this.k;
            Y y = ((M) termSearchFragment.M.getValue()).h;
            i iVar = new i(termSearchFragment, null);
            this.j = 1;
            if (e0.i(y, iVar, this) == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
