...
public abstract class Hilt_NewSearchFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            newSearchFragment.a = jVar.d.a();
            u uVar = jVar.b;
            newSearchFragment.b = uVar.S0();
            ...
            newSearchFragment.j = new com.quizlet.quizletandroid.ui.navigationmanagers.g(bVar);
        }
    }
