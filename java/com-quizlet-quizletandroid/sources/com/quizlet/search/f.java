...
public final class f extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public f(NewSearchFragment newSearchFragment, kotlin.coroutines.h hVar) {
        super(2, hVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            J viewLifecycleOwner = newSearchFragment.getViewLifecycleOwner();
            Intrinsics.checkNotNullExpressionValue(viewLifecycleOwner, "getViewLifecycleOwner(...)");
            B b = B.c;
            e eVar = new e(newSearchFragment, null);
            this.j = 1;
