...
public abstract class Hilt_TermSearchFragment extends UnstyledConvertibleModalDialogFragment implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void d0() {
        if (e0(getHost()) && !this.I) {
            this.I = true;
            TermSearchFragment termSearchFragment = (TermSearchFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((l) d());
            termSearchFragment.q = jVar.d.a();
            u uVar = jVar.b;
            com.quizlet.data.interactor.school.b bVar = new com.quizlet.data.interactor.school.b(new com.quizlet.infra.legacysyncengine.managers.g(uVar.q()), (com.quizlet.infra.legacysyncengine.managers.d) uVar.Z.get());
            com.quizlet.quizletandroid.ui.webpages.a aVar = com.quizlet.quizletandroid.ui.webpages.a.a;
            termSearchFragment.J = new com.quizlet.quizletandroid.ui.navigationmanagers.g(bVar);
        }
    }
