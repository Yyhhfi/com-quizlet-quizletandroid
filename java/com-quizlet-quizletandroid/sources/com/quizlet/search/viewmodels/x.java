...
public final class x extends AbstractC4797c {
    ...
    public x(com.quizlet.data.repository.searchexplanations.c repository, androidx.work.impl.model.c userProperties, com.quizlet.data.repository.achievements.h searchAdsManager, com.quizlet.quizletandroid.ui.common.images.capture.a searchUiMapper, SearchEventLogger searchEventLogger) {
    ...
    public final Y B(String query) {
        ...
        Intrinsics.checkNotNullParameter(config, "config");
        Intrinsics.checkNotNullParameter(pagingSourceFactory, "pagingSourceFactory");
        return AbstractC1348x.b(new androidx.compose.material3.internal.H(14, new V(new C1347w0(pagingSourceFactory, null), config).e, this), p0.j(this));
    }
}
