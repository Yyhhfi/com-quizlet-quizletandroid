...
public final class FolderWithCreatorResponseJsonAdapter extends l {
    ...
    public FolderWithCreatorResponseJsonAdapter(@NotNull D moshi) {
        ...
        this.a = cVarB;
        M m = M.a;
        l lVarA = moshi.a(FolderWithCreatorResponse.Models.class, m, "models");
    ...
    public final Object a(p reader) {
        ...
        while (reader.l()) {
            ...
            if (iK0 == -1) {
                ...
                models = (FolderWithCreatorResponse.Models) this.b.a(reader);
            } else if (iK0 == 1) {
        ...
        if (z) {
            folderWithCreatorResponse.a = pagingInfo;
        }
        if (z2) {
            folderWithCreatorResponse.b = list;
        }
        if (z3) {
            folderWithCreatorResponse.c = modelError;
        }
    ...
    public final void g(w writer, Object obj) {
        FolderWithCreatorResponse folderWithCreatorResponse = (FolderWithCreatorResponse) obj;
        ...
        writer.d();
        writer.l("models");
        this.b.g(writer, folderWithCreatorResponse.d);
        writer.l("paging");
        this.c.g(writer, folderWithCreatorResponse.a);
        writer.l("validationErrors");
        this.d.g(writer, folderWithCreatorResponse.b);
        writer.l("error");
        this.e.g(writer, folderWithCreatorResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(47, "GeneratedJsonAdapter(FolderWithCreatorResponse)", "toString(...)");
    }
}
