...
public final class SelectedTermRequestJsonAdapter extends l {
    public final com.airbnb.lottie.parser.moshi.c a;
    public final l b;
    public final l c;

    public SelectedTermRequestJsonAdapter(@NotNull D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        com.airbnb.lottie.parser.moshi.c cVarB = com.airbnb.lottie.parser.moshi.c.b("termId", "setId", "personId", "source");
    ...
    public final Object a(p reader) {
        ...
        if (num != null) {
            return new SelectedTermRequest(jLongValue, jLongValue2, num.intValue(), jLongValue3);
        }
    ...
    public final void g(w writer, Object obj) {
        ...
        writer.d();
        writer.l("termId");
        Long lValueOf = Long.valueOf(selectedTermRequest.a);
        l lVar = this.b;
        lVar.g(writer, lValueOf);
        writer.l("setId");
        Z.k(selectedTermRequest.b, lVar, writer, "personId");
        Z.k(selectedTermRequest.c, lVar, writer, "source");
        this.c.g(writer, Integer.valueOf(selectedTermRequest.d));
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(41, "GeneratedJsonAdapter(SelectedTermRequest)", "toString(...)");
    }
}
