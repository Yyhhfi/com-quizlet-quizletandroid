...
public final class ProgressResetResponseJsonAdapter extends l {
    ...
    public ProgressResetResponseJsonAdapter(@NotNull D moshi) {
        ...
        this.a = cVarB;
        M m = M.a;
        l lVarA = moshi.a(ProgressResetResponse.Models.class, m, "models");
    ...
    public final Object a(p reader) {
        ...
        while (reader.l()) {
            ...
            if (iK0 == -1) {
                ...
                models = (ProgressResetResponse.Models) this.b.a(reader);
            } else if (iK0 == 1) {
        ...
        if (z) {
            progressResetResponse.a = pagingInfo;
        }
        if (z2) {
            progressResetResponse.b = list;
        }
        if (z3) {
            progressResetResponse.c = modelError;
        }
    ...
    public final void g(w writer, Object obj) {
        ...
        writer.d();
        writer.l("models");
        this.b.g(writer, progressResetResponse.d);
        writer.l("paging");
        this.c.g(writer, progressResetResponse.a);
        writer.l("validationErrors");
        this.d.g(writer, progressResetResponse.b);
        writer.l("error");
        this.e.g(writer, progressResetResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(43, "GeneratedJsonAdapter(ProgressResetResponse)", "toString(...)");
    }
}
