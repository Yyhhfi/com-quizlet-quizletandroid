...
public final class f extends kotlin.coroutines.jvm.internal.i implements Function2 {
    ...
    public f(C3 c3, String str, kotlin.coroutines.h hVar) {
        super(2, hVar);
        this.k = c3;
        this.l = str;
    }
    ...
    public final Object invokeSuspend(Object obj) throws PracticeTestsException {
        ...
        RemoteQuestionBankResultsResponse remoteQuestionBankResultsResponse = (RemoteQuestionBankResultsResponse) ((ApiThreeWrapper) obj).a();
        if (remoteQuestionBankResultsResponse != null) {
            return ((com.quizlet.quizletandroid.ui.activitycenter.models.a) c3.g).a(remoteQuestionBankResultsResponse);
        }
        throw new PracticeTestsException("Practice Test Results should not be null");
    }
}
