...
public final class PracticeTestSchoolJsonAdapter extends l {
    public final com.airbnb.lottie.parser.moshi.c a;
    public final l b;
    public final l c;

    public PracticeTestSchoolJsonAdapter(@NotNull D moshi) {
    ...
    public final Object a(p reader) {
        ...
        if (str != null) {
            return new PracticeTestSchool(iIntValue, str);
        }
    ...
    public final void g(w writer, Object obj) {
        ...
        if (practiceTestSchool == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        writer.d();
        writer.l("id");
        this.b.g(writer, Integer.valueOf(practiceTestSchool.a));
        writer.l("name");
        this.c.g(writer, practiceTestSchool.b);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(40, "GeneratedJsonAdapter(PracticeTestSchool)", "toString(...)");
    }
}
