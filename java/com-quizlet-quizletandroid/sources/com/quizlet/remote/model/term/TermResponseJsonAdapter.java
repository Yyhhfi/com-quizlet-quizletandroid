...
public final class TermResponseJsonAdapter extends l {
    public final c a;
    public final l b;
    public final l c;
    public final l d;
    ...
    public TermResponseJsonAdapter(@NotNull D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        c cVarB = c.b("models", "paging", "validationErrors", "error");
        Intrinsics.checkNotNullExpressionValue(cVarB, "of(...)");
        this.a = cVarB;
        M m = M.a;
        l lVarA = moshi.a(TermModels.class, m, "models");
    ...
    public final Object a(p reader) {
        ...
        while (reader.l()) {
            ...
            if (iK0 == -1) {
                ...
                termModels = (TermModels) this.b.a(reader);
            } else if (iK0 == 1) {
        ...
        if (z) {
            termResponse.a = pagingInfo;
        }
        if (z2) {
            termResponse.b = list;
        }
        if (z3) {
            termResponse.c = modelError;
        }
        return termResponse;
    }
    ...
    public final void g(w writer, Object obj) {
        ...
        writer.d();
        writer.l("models");
        this.b.g(writer, termResponse.d);
        writer.l("paging");
        this.c.g(writer, termResponse.a);
        writer.l("validationErrors");
        this.d.g(writer, termResponse.b);
        writer.l("error");
        this.e.g(writer, termResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(34, "GeneratedJsonAdapter(TermResponse)", "toString(...)");
    }
}
