...
public final class ClassFolderResponseJsonAdapter extends l {
    public final c a;
    public final l b;
    public final l c;
    public final l d;
    ...
    public ClassFolderResponseJsonAdapter(@NotNull D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        c cVarB = c.b("models", "paging", "validationErrors", "error");
        Intrinsics.checkNotNullExpressionValue(cVarB, "of(...)");
        this.a = cVarB;
        M m = M.a;
        l lVarA = moshi.a(ClassFolderResponse.Models.class, m, "models");
    ...
    public final Object a(p reader) {
        ...
        while (reader.l()) {
            ...
            if (iK0 == -1) {
                ...
                models = (ClassFolderResponse.Models) this.b.a(reader);
            } else if (iK0 == 1) {
    ...
    public final void g(w writer, Object obj) {
        ClassFolderResponse classFolderResponse = (ClassFolderResponse) obj;
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (classFolderResponse == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        writer.d();
        writer.l("models");
        this.b.g(writer, classFolderResponse.d);
        writer.l("paging");
        this.c.g(writer, classFolderResponse.a);
        writer.l("validationErrors");
        this.d.g(writer, classFolderResponse.b);
        writer.l("error");
        this.e.g(writer, classFolderResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(41, "GeneratedJsonAdapter(ClassFolderResponse)", "toString(...)");
    }
}
