...
public final class TextbookResponse_ModelsJsonAdapter extends l {
    ...
    public TextbookResponse_ModelsJsonAdapter(@NotNull D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        c cVarB = c.b("textbook");
        Intrinsics.checkNotNullExpressionValue(cVarB, "of(...)");
        this.a = cVarB;
        l lVarA = moshi.a(H.f(List.class, RemoteTextbook.class), M.a, "textbooks");
    ...
    public final String toString() {
        return AbstractC4178x.m(45, "GeneratedJsonAdapter(TextbookResponse.Models)", "toString(...)");
    }
}
