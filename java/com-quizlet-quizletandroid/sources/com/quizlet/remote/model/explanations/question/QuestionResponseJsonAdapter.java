...
public final class QuestionResponseJsonAdapter extends l {
    public final c a;
    public final l b;
    public final l c;
    public final l d;
    ...
    public QuestionResponseJsonAdapter(@NotNull D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        c cVarB = c.b("models", "metering", "isContentLimited", "paging", "validationErrors", "error");
        Intrinsics.checkNotNullExpressionValue(cVarB, "of(...)");
        this.a = cVarB;
        M m = M.a;
        l lVarA = moshi.a(QuestionResponse.Models.class, m, "models");
        Intrinsics.checkNotNullExpressionValue(lVarA, "adapter(...)");
        this.b = lVarA;
        l lVarA2 = moshi.a(RemoteMeteringInfo.class, m, "explanationsMeteringInfo");
    ...
    public final Object a(p reader) {
        ...
        while (reader.l()) {
            switch (reader.k0(this.a)) {
                case -1:
                    ...
                    break;
                case 0:
                    models = (QuestionResponse.Models) this.b.a(reader);
                    break;
                case 1:
        ...
        reader.i();
        QuestionResponse questionResponse = new QuestionResponse(models, remoteMeteringInfo, bool);
        if (z) {
            questionResponse.a = pagingInfo;
        }
        if (z2) {
            questionResponse.b = list;
        }
        if (z3) {
            questionResponse.c = modelError;
        }
    ...
    public final void g(w writer, Object obj) {
        ...
        writer.d();
        writer.l("models");
        this.b.g(writer, questionResponse.d);
        writer.l("metering");
        this.c.g(writer, questionResponse.e);
        writer.l("isContentLimited");
        this.d.g(writer, questionResponse.f);
        writer.l("paging");
        this.e.g(writer, questionResponse.a);
        writer.l("validationErrors");
        this.f.g(writer, questionResponse.b);
        writer.l("error");
        this.g.g(writer, questionResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(38, "GeneratedJsonAdapter(QuestionResponse)", "toString(...)");
    }
}
