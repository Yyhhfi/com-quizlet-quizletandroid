...
public final class FolderSetResponse_ModelsJsonAdapter extends l {
    ...
    public FolderSetResponse_ModelsJsonAdapter(@NotNull D moshi) {
        ...
        c cVarB = c.b("folderSet");
        Intrinsics.checkNotNullExpressionValue(cVarB, "of(...)");
        this.a = cVarB;
        l lVarA = moshi.a(H.f(List.class, RemoteFolderSet.class), M.a, "folderSet");
    ...
    public final String toString() {
        return AbstractC4178x.m(46, "GeneratedJsonAdapter(FolderSetResponse.Models)", "toString(...)");
    }
}
