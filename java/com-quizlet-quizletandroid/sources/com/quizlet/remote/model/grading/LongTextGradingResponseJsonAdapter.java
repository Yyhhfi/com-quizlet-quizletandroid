...
public final class LongTextGradingResponseJsonAdapter extends l {
    public final c a;
    public final l b;
    public final l c;
    public final l d;
    ...
    public LongTextGradingResponseJsonAdapter(@NotNull D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        c cVarB = c.b("data", "paging", "validationErrors", "error");
        Intrinsics.checkNotNullExpressionValue(cVarB, "of(...)");
        this.a = cVarB;
        M m = M.a;
        l lVarA = moshi.a(LongTextGradingResult.class, m, "data");
    ...
    public final Object a(p reader) {
        ...
        while (reader.l()) {
            ...
            if (iK0 == -1) {
                ...
                longTextGradingResult = (LongTextGradingResult) this.b.a(reader);
            } else if (iK0 == 1) {
    ...
    public final void g(w writer, Object obj) {
        LongTextGradingResponse longTextGradingResponse = (LongTextGradingResponse) obj;
        Intrinsics.checkNotNullParameter(writer, "writer");
        if (longTextGradingResponse == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        writer.d();
        writer.l("data");
        this.b.g(writer, longTextGradingResponse.d);
        writer.l("paging");
        this.c.g(writer, longTextGradingResponse.a);
        writer.l("validationErrors");
        this.d.g(writer, longTextGradingResponse.b);
        writer.l("error");
        this.e.g(writer, longTextGradingResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(45, "GeneratedJsonAdapter(LongTextGradingResponse)", "toString(...)");
    }
}
