...
public final class UsernameCheckResponseJsonAdapter extends l {
    public final c a;
    public final l b;
    public final l c;
    public final l d;
    ...
    public UsernameCheckResponseJsonAdapter(@NotNull D moshi) {
        Intrinsics.checkNotNullParameter(moshi, "moshi");
        c cVarB = c.b("data", "paging", "validationErrors", "error");
        Intrinsics.checkNotNullExpressionValue(cVarB, "of(...)");
        this.a = cVarB;
        M m = M.a;
        l lVarA = moshi.a(UsernameCheckData.class, m, "data");
    ...
    public final Object a(p reader) {
        ...
        while (reader.l()) {
            ...
            if (iK0 == -1) {
                ...
                usernameCheckData = (UsernameCheckData) this.b.a(reader);
    ...
    public final void g(w writer, Object obj) {
        UsernameCheckResponse usernameCheckResponse = (UsernameCheckResponse) obj;
        ...
        writer.d();
        writer.l("data");
        this.b.g(writer, usernameCheckResponse.d);
        writer.l("paging");
        this.c.g(writer, usernameCheckResponse.a);
        writer.l("validationErrors");
        this.d.g(writer, usernameCheckResponse.b);
        writer.l("error");
        this.e.g(writer, usernameCheckResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(43, "GeneratedJsonAdapter(UsernameCheckResponse)", "toString(...)");
    }
}
