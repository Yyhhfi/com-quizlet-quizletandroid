...
public final class RemoteMeteringInfoJsonAdapter extends l {
    ...
    public final Object a(p reader) {
        ...
        if (num2 != null) {
            return new RemoteMeteringInfo(iIntValue, num2.intValue());
        }
    ...
    public final void g(w writer, Object obj) {
        ...
        writer.d();
        writer.l("numEvents");
        Integer numValueOf = Integer.valueOf(remoteMeteringInfo.a);
        l lVar = this.b;
    ...
    public final String toString() {
        return AbstractC4178x.m(40, "GeneratedJsonAdapter(RemoteMeteringInfo)", "toString(...)");
    }
}
