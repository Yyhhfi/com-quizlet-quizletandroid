...
public final class UserResponseJsonAdapter extends l {
    ...
    public UserResponseJsonAdapter(@NotNull D moshi) {
        ...
        this.a = cVarB;
        M m = M.a;
        l lVarA = moshi.a(UserModels.class, m, "models");
    ...
    public final Object a(p reader) {
        ...
        while (reader.l()) {
            ...
            if (iK0 == -1) {
                ...
                userModels = (UserModels) this.b.a(reader);
            } else if (iK0 == 1) {
    ...
    public final void g(w writer, Object obj) {
        ...
        writer.d();
        writer.l("models");
        this.b.g(writer, userResponse.d);
        writer.l("paging");
        this.c.g(writer, userResponse.a);
        writer.l("validationErrors");
        this.d.g(writer, userResponse.b);
        writer.l("error");
        this.e.g(writer, userResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(34, "GeneratedJsonAdapter(UserResponse)", "toString(...)");
    }
}
