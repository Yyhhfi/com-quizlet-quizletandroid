...
public final class FullUserResponseJsonAdapter extends l {
    public final c a;
    public final l b;
    public final l c;
    public final l d;
    ...
    public FullUserResponseJsonAdapter(@NotNull D moshi) {
    ...
    public final void g(w writer, Object obj) {
        ...
        writer.d();
        writer.l("models");
        this.b.g(writer, fullUserResponse.d);
        writer.l("paging");
        this.c.g(writer, fullUserResponse.a);
        writer.l("validationErrors");
        this.d.g(writer, fullUserResponse.b);
        writer.l("error");
        this.e.g(writer, fullUserResponse.c);
        writer.f();
    }

    public final String toString() {
        return AbstractC4178x.m(38, "GeneratedJsonAdapter(FullUserResponse)", "toString(...)");
    }
}
