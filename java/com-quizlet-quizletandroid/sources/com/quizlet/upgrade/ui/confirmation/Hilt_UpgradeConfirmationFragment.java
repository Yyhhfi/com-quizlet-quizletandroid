...
public abstract class Hilt_UpgradeConfirmationFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    public j e;
    public boolean f;
    public volatile f g;
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            UpgradeConfirmationFragment upgradeConfirmationFragment = (UpgradeConfirmationFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((b) d());
            upgradeConfirmationFragment.a = jVar.d.a();
            upgradeConfirmationFragment.b = jVar.b.S0();
        }
    }
