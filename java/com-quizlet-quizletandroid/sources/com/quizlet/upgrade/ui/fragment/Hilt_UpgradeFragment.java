...
public abstract class Hilt_UpgradeFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            upgradeFragment.a = jVar.d.a();
            u uVar = jVar.b;
            upgradeFragment.b = uVar.S0();
            upgradeFragment.j = uVar.q1();
            com.quizlet.quizletandroid.util.g gVar = (com.quizlet.quizletandroid.util.g) uVar.B1.get();
