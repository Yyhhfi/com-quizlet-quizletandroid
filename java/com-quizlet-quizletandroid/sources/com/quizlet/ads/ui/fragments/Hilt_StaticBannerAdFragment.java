...
public abstract class Hilt_StaticBannerAdFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            StaticBannerAdFragment staticBannerAdFragment = (StaticBannerAdFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((i) d());
            staticBannerAdFragment.a = jVar.d.a();
            u uVar = jVar.b;
            staticBannerAdFragment.b = uVar.S0();
            staticBannerAdFragment.k = (com.quizlet.ads.g) uVar.v1.get();
        }
    }
