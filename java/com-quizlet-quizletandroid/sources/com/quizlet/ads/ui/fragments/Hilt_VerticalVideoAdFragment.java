...
public abstract class Hilt_VerticalVideoAdFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            VerticalVideoAdFragment verticalVideoAdFragment = (VerticalVideoAdFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((k) d());
            verticalVideoAdFragment.a = jVar.d.a();
            u uVar = jVar.b;
            verticalVideoAdFragment.b = uVar.S0();
            verticalVideoAdFragment.k = (com.quizlet.ads.g) uVar.v1.get();
            verticalVideoAdFragment.l = jVar.a();
        }
    }
