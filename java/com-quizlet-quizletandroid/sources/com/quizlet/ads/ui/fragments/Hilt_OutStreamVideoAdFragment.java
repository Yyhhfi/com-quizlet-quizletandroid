...
public abstract class Hilt_OutStreamVideoAdFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            this.i = true;
            OutStreamVideoAdFragment outStreamVideoAdFragment = (OutStreamVideoAdFragment) this;
            com.quizlet.quizletandroid.j jVar = (com.quizlet.quizletandroid.j) ((f) d());
            outStreamVideoAdFragment.a = jVar.d.a();
            u uVar = jVar.b;
            outStreamVideoAdFragment.b = uVar.S0();
            outStreamVideoAdFragment.k = (com.quizlet.ads.g) uVar.v1.get();
            outStreamVideoAdFragment.l = jVar.a();
        }
    }
