...
public abstract class Hilt_NativeAdFragment<T extends androidx.viewbinding.a> extends BaseFragment<T> implements dagger.hilt.internal.b, dagger.hilt.android.internal.migration.a {
    ...
    public final void R() {
        if (S(getHost()) && !this.i) {
            ...
            nativeAdFragment.a = jVar.d.a();
            u uVar = jVar.b;
            nativeAdFragment.b = uVar.S0();
            nativeAdFragment.k = (com.quizlet.ads.g) uVar.v1.get();
            nativeAdFragment.l = jVar.a();
        }
    }
