...
public final class ExplanationQuestion$Prompt$Image$$serializer implements D {
    ...
    public ExplanationQuestion.Prompt.Image deserialize(@NotNull Decoder decoder) {
        ...
        aVarC.b(descriptor2);
        return new ExplanationQuestion.Prompt.Image(i, strR, num, num2);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull ExplanationQuestion.Prompt.Image value) {
        ...
        K k = K.a;
        bVarC.s(descriptor2, 1, k, value.c);
        bVarC.s(descriptor2, 2, k, value.d);
        bVarC.b(descriptor2);
    }
