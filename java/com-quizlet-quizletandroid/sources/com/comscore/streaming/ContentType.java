...
public interface ContentType {
    ...
    public static final int[] ALLOWED_VALUES = {LONG_FORM_ON_DEMAND, 111, LIVE, USER_GENERATED_LONG_FORM_ON_DEMAND, USER_GENERATED_SHORT_FORM_ON_DEMAND, USER_GENERATED_LIVE, BUMPER, 100};
}
