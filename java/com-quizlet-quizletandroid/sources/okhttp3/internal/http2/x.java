...
public abstract class x {
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            ...
            int i6 = (i2 << i5) & 255;
            Intrinsics.d(u0Arr);
            Intrinsics.checkNotNullParameter(u0Arr, "<this>");
            Arrays.fill(u0Arr, i6, (1 << i5) + i6, u0);
        }
    }
}
