...
public class FileProvider extends ContentProvider {
    ...
    public static d d(Context context, String str) throws XmlPullParserException, IOException {
        ...
        if (providerInfoResolveContentProvider == null) {
            throw new IllegalArgumentException(AbstractC0147y.d("Couldn't find meta-data for provider with authority ", str));
        }
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if (externalStorageDirectory == null) {
                    ...
                    try {
                        dVar.b.put(attributeValue, externalStorageDirectory.getCanonicalFile());
                    } catch (IOException e2) {
    ...
    public final ParcelFileDescriptor openFile(Uri uri, String str) {
        ...
        if ("r".equals(str)) {
            ...
            if (!"rwt".equals(str)) {
                throw new IllegalArgumentException(AbstractC0147y.d("Invalid mode: ", str));
            }
            i = 1006632960;
        }
