    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            androidx.appcompat.widget.y0 r6 = (androidx.appcompat.widget.C0121y0) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r2
        L73:
        ...
        if (mode2 != 1073741824) {
            ...
            while (i8 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0121y0).width == -1) {
                        int i9 = ((LinearLayout.LayoutParams) c0121y0).height;
                        ((LinearLayout.LayoutParams) c0121y0).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i7, 0);
                        ((LinearLayout.LayoutParams) c0121y0).height = i9;
                    }
                }
                i8++;
