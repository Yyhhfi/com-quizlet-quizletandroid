...
public class C0120y extends ImageButton {
    public final C0105q a;
    public final C0122z b;
    public boolean c;

    public C0120y(@NonNull Context context) {
        this(context, null);
    }
    ...
    public C0120y(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, R.attr.imageButtonStyle);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0120y(Context context, AttributeSet attributeSet, int i) {
