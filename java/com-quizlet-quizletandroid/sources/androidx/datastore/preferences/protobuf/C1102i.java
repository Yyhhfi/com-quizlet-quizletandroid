...
public final class C1102i extends AbstractC1047f0 {
    ...
    public C1102i(InputStream inputStream) {
        AbstractC1115w.a(inputStream, "input");
        this.c = inputStream;
    ...
    @Override // androidx.core.view.AbstractC1047f0
    public final C1100g k() throws IOException {
        int iO0 = o0();
        int i = this.e;
        int i2 = this.g;
        int i3 = i - i2;
        byte[] bArr = this.d;
        if (iO0 <= i3 && iO0 > 0) {
            C1100g c1100gC = C1100g.c(i2, bArr, iO0);
            this.g += iO0;
            return c1100gC;
        }
        if (iO0 == 0) {
        ...
        byte[] bArrK0 = k0(iO0);
        if (bArrK0 != null) {
            return C1100g.c(0, bArrK0, bArrK0.length);
        }
        int i4 = this.g;
        int i5 = this.e;
        int length = i5 - i4;
        ...
        return new C1100g(bArr2);
    }

    public final byte[] k0(int i) throws IOException {
        if (i == 0) {
            return AbstractC1115w.b;
        }
        if (i < 0) {
            throw InvalidProtocolBufferException.d();
        }
    ...
    public final String z() throws InvalidProtocolBufferException {
        ...
        if (iO0 > 0) {
            ...
            int i2 = this.g;
            if (iO0 <= i - i2) {
                String str = new String(bArr, i2, iO0, AbstractC1115w.a);
                this.g += iO0;
                return str;
            }
        }
        ...
        if (iO0 > this.e) {
            return new String(j0(iO0), AbstractC1115w.a);
        }
        s0(iO0);
        String str2 = new String(bArr, this.g, iO0, AbstractC1115w.a);
        this.g += iO0;
        return str2;
    }
}
