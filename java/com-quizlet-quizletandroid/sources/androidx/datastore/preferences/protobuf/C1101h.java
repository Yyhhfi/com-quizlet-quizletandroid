...
public final class C1101h extends AbstractC1047f0 {
    public final byte[] c;
    public int d;
    public int e;
    public int f;
    ...
    public C1101h(byte[] bArr, int i, int i2, boolean z) {
        this.c = bArr;
        this.d = i2 + i;
        this.f = i;
        this.g = i;
    ...
    public final String A() throws InvalidProtocolBufferException {
        ...
        if (iL0 > 0) {
            ...
            int i2 = this.f;
            if (iL0 <= i - i2) {
                String strB = j0.a.b(i2, this.c, iL0);
                this.f += iL0;
                return strB;
            }
        }
    ...
    */
    public final androidx.datastore.preferences.protobuf.C1100g k() throws androidx.datastore.preferences.protobuf.InvalidProtocolBufferException {
        /*
            r4 = this;
            int r0 = r4.l0()
            byte[] r1 = r4.c
            ...
            int r2 = r2 - r3
            if (r0 > r2) goto L19
            androidx.datastore.preferences.protobuf.g r1 = androidx.datastore.preferences.protobuf.C1100g.c(r3, r1, r0)
            int r2 = r4.f
            int r2 = r2 + r0
            r4.f = r2
            return r1
        L19:
            if (r0 != 0) goto L1e
            androidx.datastore.preferences.protobuf.g r0 = androidx.datastore.preferences.protobuf.C1100g.c
            return r0
        L1e:
            if (r0 <= 0) goto L2f
            int r2 = r4.d
        ...
        L2f:
            if (r0 > 0) goto L42
            if (r0 != 0) goto L3d
            byte[] r0 = androidx.datastore.preferences.protobuf.AbstractC1115w.b
        L35:
            androidx.datastore.preferences.protobuf.g r1 = androidx.datastore.preferences.protobuf.C1100g.c
        ...
        L42:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.preferences.protobuf.C1101h.k():androidx.datastore.preferences.protobuf.g");
    }
    ...
    public final String z() throws InvalidProtocolBufferException {
        ...
        if (iL0 > 0) {
            ...
            int i2 = this.f;
            if (iL0 <= i - i2) {
                String str = new String(this.c, i2, iL0, AbstractC1115w.a);
                this.f += iL0;
                return str;
            }
        }
