...
public final class a0 {
    public static final a0 f = new a0(0, new int[0], new Object[0], false);
    public int a;
    public int[] b;
    public Object[] c;
    public int d = -1;
        ...
        for (int i3 = 0; i3 < this.a; i3++) {
            ...
            if (i6 != 0) {
                if (i6 == 1) {
                    ...
                    iJ2 = C1104k.h(i5, (C1100g) this.c[i3]);
                } else if (i6 == 3) {
                    iJ = C1104k.j(i5) * 2;
                    iL = ((a0) this.c[i3]).b();
                } else {
    ...
    public final void d(C c) {
        ...
        for (int i = 0; i < this.a; i++) {
            ...
            if (i4 == 0) {
                c1104k.F(i3, ((Long) obj).longValue());
            } else if (i4 == 1) {
                c1104k.v(i3, ((Long) obj).longValue());
            } else if (i4 == 2) {
                c1104k.r(i3, (C1100g) obj);
            } else if (i4 == 3) {
                c1104k.C(i3, 3);
                ((a0) obj).d(c);
                c1104k.C(i3, 4);
                ...
                c1104k.t(i3, ((Integer) obj).intValue());
            }
        }
    }
