...
public abstract class AbstractC0863b {
    ...
    public static final void a(C0864c c0864c, H h) {
        int size = h.j.size();
        for (int i = 0; i < size; i++) {
            J j = (J) h.j.get(i);
            if (j instanceof L) {
                C0870i c0870i = new C0870i();
                L l = (L) j;
                c0870i.d = l.b;
                c0870i.n = true;
                c0870i.c();
    ...
    public static final void b(O o, double d, double d2, double d3, double d4, double d5, double d6, double d7, boolean z, boolean z2) {
        double d8;
        double d9;
        double d10 = d5;
        ...
        if (d22 < 0.0d) {
            ...
            b(o, d, d2, d3, d4, d10 * dSqrt, d6 * dSqrt, d7, z, z2);
            return;
        }
        ...
        while (i < iCeil) {
            ...
            ((C0850j) o).a.cubicTo((float) ((d39 * dSqrt3) + d43), (float) ((d40 * dSqrt3) + d41), (float) (d45 - (dSqrt3 * d47)), (float) (d46 - (dSqrt3 * d48)), (float) d45, (float) d46);
            dSin2 = dSin2;
            d43 = d45;
            i = i2 + 1;
            d27 = d27;
    ...
    public static final K c(C0867f c0867f, InterfaceC0806l interfaceC0806l) {
        C0853m c0853m;
        C0814p c0814p = (C0814p) interfaceC0806l;
        androidx.compose.ui.unit.b bVar = (androidx.compose.ui.unit.b) c0814p.j(AbstractC0955m0.f);
        float f = c0867f.j;
        boolean zE = c0814p.e((Float.floatToRawIntBits(bVar.a()) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
        Object objI = c0814p.I();
        if (zE || objI == C0804k.a) {
            C0864c c0864c = new C0864c();
            a(c0864c, c0867f.f);
            Unit unit = Unit.a;
            long jA = T4.a(bVar.c0(c0867f.b), bVar.c0(c0867f.c));
            float fD = c0867f.d;
            if (Float.isNaN(fD)) {
                fD = androidx.compose.ui.geometry.e.d(jA);
            }
            float fB = c0867f.e;
            if (Float.isNaN(fB)) {
                fB = androidx.compose.ui.geometry.e.b(jA);
            }
            long jA2 = T4.a(fD, fB);
            K k = new K(c0864c);
            long j = c0867f.g;
            if (j != 16) {
                ...
                int i2 = c0867f.h;
                c0853m = new C0853m(j, i2, i >= 29 ? C0854n.a.a(j, i2) : new PorterDuffColorFilter(androidx.compose.ui.graphics.F.A(j), androidx.compose.ui.graphics.F.E(i2)));
            } else {
                c0853m = null;
            }
            ((L0) k.f).setValue(new androidx.compose.ui.geometry.e(jA));
            ((L0) k.g).setValue(Boolean.valueOf(c0867f.i));
            F f2 = k.h;
            ((L0) f2.g).setValue(c0853m);
            ((L0) f2.i).setValue(new androidx.compose.ui.geometry.e(jA2));
            f2.c = c0867f.a;
            c0814p.i0(k);
            objI = k;
        }
    ...
    public static final void d(List list, O o) {
        int i;
        int i2;
        Path path;
        float f;
        ...
        int i3 = 0;
        int i4 = c0850j.a.getFillType() == Path.FillType.EVEN_ODD ? 1 : 0;
        Path path2 = c0850j.a;
        path2.rewind();
        c0850j.f(i4);
        C c3 = list2.isEmpty() ? C0872k.c : (C) list2.get(0);
        int size = list2.size();
                    ...
                    if (c4 instanceof o) {
                        ...
                        if (c4 instanceof v) {
                            ...
                            if (c4 instanceof n) {
                                ...
                                u uVar = (u) c4;
                                path2.rLineTo(uVar.c, f10);
                                f13 += uVar.c;
                            } else if (c4 instanceof m) {
                                m mVar = (m) c4;
                                path2.lineTo(mVar.c, f14);
                                f13 = mVar.c;
                            } else {
                                if (c4 instanceof A) {
                                    A a2 = (A) c4;
                                    path2.rLineTo(f10, a2.c);
                                    f9 = a2.c;
                                } else if (c4 instanceof B) {
                                    B b2 = (B) c4;
                                    path2.lineTo(f13, b2.c);
                                    f14 = b2.c;
                                    ...
                                    if (c4 instanceof C0873l) {
                                        C0873l c0873l = (C0873l) c4;
                                        path2.cubicTo(c0873l.c, c0873l.d, c0873l.e, c0873l.f, c0873l.g, c0873l.h);
                                        f11 = c0873l.e;
                                        f12 = c0873l.f;
                                        f5 = c0873l.g;
                                        f6 = c0873l.h;
                                        ...
                                        y yVar = (y) c4;
                                        path2.rCubicTo(f7, f8, yVar.c, yVar.d, yVar.e, yVar.f);
                                        f11 = yVar.c + f13;
                                        f12 = yVar.d + f14;
                                        f13 += yVar.e;
                                        f9 = yVar.f;
                                        ...
                                        q qVar = (q) c4;
                                        path2.cubicTo(f13, f14, qVar.c, qVar.d, qVar.e, qVar.f);
                                        f11 = qVar.c;
                                        f12 = qVar.d;
                                        f5 = qVar.e;
                                        f6 = qVar.f;
                                    } else if (c4 instanceof x) {
                                        x xVar = (x) c4;
                                        float f25 = xVar.c;
                                        float f26 = xVar.d;
                                        float f27 = xVar.e;
                                        float f28 = xVar.f;
                                        path2.rQuadTo(f25, f26, f27, f28);
                                        float f29 = xVar.c + f13;
                                        f12 = f26 + f14;
                                        f13 += f27;
                                        f14 += f28;
                                        f11 = f29;
                                    } else if (c4 instanceof p) {
                                        p pVar = (p) c4;
                                        float f30 = pVar.c;
                                        f12 = pVar.d;
                                        float f31 = pVar.e;
                                        f4 = pVar.f;
                                        path2.quadTo(f30, f12, f31, f4);
                                        f11 = pVar.c;
                                        i = size;
                                        i2 = i3;
                                        path = path2;
                                        ...
                                        if (c4 instanceof z) {
                                            ...
                                            if (c4 instanceof s) {
                                                s sVar = (s) c4;
                                                float f40 = sVar.h + f13;
                                                float f41 = sVar.i + f14;
                                                double d = sVar.c;
                                                double d2 = sVar.d;
                                                double d3 = sVar.e;
                                                boolean z = sVar.f;
                                                ...
                                                c = c4;
                                                c0850j = c0850j;
                                                b(c0850j, f13, f14, f40, f41, d, d2, d3, z, z2);
                                                f11 = f40;
                                                f13 = f11;
                                                f12 = f41;
                                                f14 = f12;
                                                ...
                                                f = f10;
                                                c = c4;
                                                if (c instanceof C0871j) {
                                                    C0871j c0871j = (C0871j) c;
                                                    double d4 = c0871j.h;
                                                    float f42 = c0871j.i;
                                                    c2 = c;
                                                    c0850j = c0850j;
                                                    b(c0850j, f13, f14, d4, f42, c0871j.c, c0871j.d, c0871j.e, c0871j.f, c0871j.g);
                                                    f11 = c0871j.h;
                                                    f13 = f11;
                                                    f12 = f42;
                                                }
