...
public final class MatchingGameAnswerPair {
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder("MatchingGameAnswerPair(firstIndex=");
        sb.append(this.a);
        sb.append(", secondIndex=");
        return android.support.v4.media.session.a.r(sb, this.b, ")");
    }

    public /* synthetic */ MatchingGameAnswerPair(int i, int i2, int i3) {
        if (3 != (i & 3)) {
            AbstractC5047c0.k(i, 3, MatchingGameAnswerPair$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.a = i2;
        this.b = i3;
