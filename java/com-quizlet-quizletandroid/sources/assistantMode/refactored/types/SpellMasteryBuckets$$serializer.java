...
public final class SpellMasteryBuckets$$serializer implements D {
    ...
    public KSerializer[] childSerializers() {
        KSerializer[] kSerializerArr = SpellMasteryBuckets.d;
    ...
    public SpellMasteryBuckets deserialize(@NotNull Decoder decoder) {
        ...
        aVarC.b(descriptor2);
        return new SpellMasteryBuckets(i, list, list2, list3);
    }
