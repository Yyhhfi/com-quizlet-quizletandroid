...
public final class TaskRoundProgress$$serializer implements D {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("assistantMode.refactored.types.TaskRoundProgress", taskRoundProgress$$serializer, 2);
    ...
    @NotNull
    public TaskRoundProgress deserialize(@NotNull Decoder decoder) {
        ...
        aVarC.b(descriptor2);
        return new TaskRoundProgress(i, iN, iN2);
    }
    ...
    @Override // kotlinx.serialization.KSerializer
    public void serialize(@NotNull Encoder encoder, @NotNull TaskRoundProgress value) {
