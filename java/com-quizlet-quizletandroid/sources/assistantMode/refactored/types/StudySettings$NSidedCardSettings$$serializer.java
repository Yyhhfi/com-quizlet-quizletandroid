...
public final class StudySettings$NSidedCardSettings$$serializer implements D {
    ...
    public KSerializer[] childSerializers() {
        KSerializer[] kSerializerArr = StudySettings.NSidedCardSettings.f;
        return new KSerializer[]{kSerializerArr[0], kSerializerArr[1], kSerializerArr[2], kSerializerArr[3], kSerializerArr[4]};
    }

    @Override // kotlinx.serialization.KSerializer
    @NotNull
    public StudySettings.NSidedCardSettings deserialize(@NotNull Decoder decoder) {
    ...
    @Override // kotlinx.serialization.KSerializer
    public void serialize(@NotNull Encoder encoder, @NotNull StudySettings.NSidedCardSettings value) {
        ...
        List list = value.e;
        if (zD || !Intrinsics.b(list, assistantMode.a.a)) {
