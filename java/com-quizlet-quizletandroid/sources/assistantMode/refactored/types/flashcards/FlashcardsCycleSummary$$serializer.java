...
public final class FlashcardsCycleSummary$$serializer implements D {
    ...
    public KSerializer[] childSerializers() {
        return new KSerializer[]{FlashcardsCycleSummary.d[0], FlashcardsModeProgress$$serializer.INSTANCE, FlashcardsStepMetadata$$serializer.INSTANCE};
    }

    @Override // kotlinx.serialization.KSerializer
    @NotNull
    public FlashcardsCycleSummary deserialize(@NotNull Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        SerialDescriptor descriptor2 = getDescriptor();
        kotlinx.serialization.encoding.a aVarC = decoder.c(descriptor2);
        KSerializer[] kSerializerArr = FlashcardsCycleSummary.d;
        a aVar = null;
        boolean z = true;
        int i = 0;
        ...
        aVarC.b(descriptor2);
        return new FlashcardsCycleSummary(i, aVar, flashcardsModeProgress, flashcardsStepMetadata);
    }
    ...
    @Override // kotlinx.serialization.KSerializer
    public void serialize(@NotNull Encoder encoder, @NotNull FlashcardsCycleSummary value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(value, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        kotlinx.serialization.encoding.b bVarC = encoder.c(descriptor2);
        bVarC.i(descriptor2, 0, FlashcardsCycleSummary.d[0], value.a);
